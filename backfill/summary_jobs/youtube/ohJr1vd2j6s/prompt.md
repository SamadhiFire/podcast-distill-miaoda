...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/ohJr1vd2j6s/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/ohJr1vd2j6s/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/ohJr1vd2j6s/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:ohJr1vd2j6s",
  "platform": "youtube",
  "platform_id": "ohJr1vd2j6s",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/4/2025",
  "url": "https://www.youtube.com/watch?v=ohJr1vd2j6s",
  "published_at": "2025-08-04T15:14:52+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/ohJr1vd2j6s/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-05",
  "duration_seconds": 8661,
  "transcript_sha256": "38365ed0cbdde84415c866402698dd5aafb73a3faeb075d617f41809910e3570",
  "transcript_text_chars": 150323,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9994411730747027,
    "text_chars": 150323,
    "completed_at": "2026-06-29 08:28:15"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:ohJr1vd2j6s
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/fdM3u1DrDrM/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/fdM3u1DrDrM/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/fdM3u1DrDrM/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:fdM3u1DrDrM",
  "platform": "youtube",
  "platform_id": "fdM3u1DrDrM",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "Tom Barkin on Why Central Banking Is on Hard Mode Now | Odd Lots",
  "url": "https://www.youtube.com/watch?v=fdM3u1DrDrM",
  "published_at": "2025-08-25T14:43:55+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/fdM3u1DrDrM/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-26",
  "duration_seconds": 1726,
  "transcript_sha256": "36e44f24918f4433e5fb9685a1e79d3167123f1b8531e790084cc5d86d92f0d2",
  "transcript_text_chars": 31803,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9943395133256083,
    "text_chars": 31803,
    "completed_at": "2026-06-29 09:29:57"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:fdM3u1DrDrM
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/YTyQzLNDIUw/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/YTyQzLNDIUw/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/YTyQzLNDIUw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:YTyQzLNDIUw",
  "platform": "youtube",
  "platform_id": "YTyQzLNDIUw",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "China's Top Priority: Ending Price Wars | Bloomberg: The China Show 07/31/2025",
  "url": "https://www.youtube.com/watch?v=YTyQzLNDIUw",
  "published_at": "2025-07-31T05:44:13+00:00",
  "report_date": "2025-08-01",
  "duration_seconds": 5547,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/YTyQzLNDIUw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-01",
  "duration_seconds": 5547,
  "transcript_sha256": "da518a3eeb781b200404905b97b4f6e34ecce22639bbb94b13f496bfbba36e32",
  "transcript_text_chars": 89777,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.998637101135749,
    "text_chars": 89777,
    "completed_at": "2026-06-29 08:23:07"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:YTyQzLNDIUw
```

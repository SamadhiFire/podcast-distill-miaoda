...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/xCd9ykretlg/transcript.txt`
- 写入结果文件：`backfill/items/youtube/xCd9ykretlg/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:xCd9ykretlg",
  "platform": "youtube",
  "platform_id": "xCd9ykretlg",
  ...
  "published_at": "2026-04-12T12:31:17+00:00",
  "report_date": "2026-04-13",
  "duration_seconds": 4960,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/xCd9ykretlg/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-04-13",
  "duration_seconds": 4960,
  "transcript_sha256": "59313cb34c2b06a43f57acb6e8e102159ccd6abdfbaa1f2e7ea932bf75e60105",
  "transcript_text_chars": 86577,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9991935483870967,
    "text_chars": 86577,
    "completed_at": "2026-06-29 13:23:12"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:xCd9ykretlg
```

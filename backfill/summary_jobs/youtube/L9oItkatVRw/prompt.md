...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/L9oItkatVRw/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/L9oItkatVRw/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/L9oItkatVRw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:L9oItkatVRw",
  "platform": "youtube",
  "platform_id": "L9oItkatVRw",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Trump’s Texas Power Grab",
  "url": "https://www.youtube.com/watch?v=L9oItkatVRw",
  "published_at": "2025-08-04T14:33:30+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/L9oItkatVRw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-05",
  "duration_seconds": 1635,
  "transcript_sha256": "39bc4a49831771485e72c5ba69557d76c93843c10987c1a3be13109906c2a4cf",
  "transcript_text_chars": 23711,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.997645259938838,
    "text_chars": 23711,
    "completed_at": "2026-06-29 08:28:04"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:L9oItkatVRw
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/hlh7j8GeWB8/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/hlh7j8GeWB8/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/hlh7j8GeWB8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:hlh7j8GeWB8",
  "platform": "youtube",
  "platform_id": "hlh7j8GeWB8",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "The Sprawling Government Effort to Prosecute Barack Obama",
  "url": "https://www.youtube.com/watch?v=hlh7j8GeWB8",
  "published_at": "2025-08-13T14:19:22+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/hlh7j8GeWB8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-14",
  "duration_seconds": 1652,
  "transcript_sha256": "8b31357ab2f2ab142e5d1c8231ee33469f6f63273da332e17168354f5743b453",
  "transcript_text_chars": 20132,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9982869249394674,
    "text_chars": 20132,
    "completed_at": "2026-06-29 08:50:40"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:hlh7j8GeWB8
```

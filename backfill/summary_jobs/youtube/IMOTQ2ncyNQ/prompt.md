...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/IMOTQ2ncyNQ/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/IMOTQ2ncyNQ/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/IMOTQ2ncyNQ/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:IMOTQ2ncyNQ",
  "platform": "youtube",
  "platform_id": "IMOTQ2ncyNQ",
  "source_id": "yt_cannonball",
  "source_name": "Cannonball with Wesley Morris",
  "category": "文化 / 社会 / 人文",
  "title": "‘Sinners,’ Hollywood Deals and Vampiric Threats to Black Art in America | Oscars 2026",
  "url": "https://www.youtube.com/watch?v=IMOTQ2ncyNQ",
  "published_at": "2025-07-31T11:05:00+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/IMOTQ2ncyNQ/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-01",
  "duration_seconds": 2433,
  "transcript_sha256": "9faa6a269478885e7a50f7677d6a19347c3ea37c94d177644e351837463395bf",
  "transcript_text_chars": 30194,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.998997122893547,
    "text_chars": 30194,
    "completed_at": "2026-06-29 08:23:55"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:IMOTQ2ncyNQ
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/j7ypvRUFY7M/transcript.txt`
- 写入结果文件：`backfill/items/youtube/j7ypvRUFY7M/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:j7ypvRUFY7M",
  "platform": "youtube",
  "platform_id": "j7ypvRUFY7M",
  ...
  "published_at": "2026-05-19T12:00:56+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/j7ypvRUFY7M/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-20",
  "duration_seconds": 2304,
  "transcript_sha256": "47e331b500d995472bc13c2f5bbfc7ea871eeab9bb5dd85d7b523f4caa938d2c",
  "transcript_text_chars": 44005,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.99644140625,
    "text_chars": 44005,
    "completed_at": "2026-06-29 13:53:36"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:j7ypvRUFY7M
```

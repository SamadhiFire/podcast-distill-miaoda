...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/JMeXWVw0r3E/transcript.txt`
- 写入结果文件：`backfill/items/youtube/JMeXWVw0r3E/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:JMeXWVw0r3E",
  "platform": "youtube",
  "platform_id": "JMeXWVw0r3E",
  ...
  "published_at": "2025-10-26T11:00:37+00:00",
  "report_date": "2025-10-27",
  "duration_seconds": 5202,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/JMeXWVw0r3E/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-10-27",
  "duration_seconds": 5202,
  "transcript_sha256": "aaa40752bbd3f6f5cb7ee7fbd4ee2026bbb4e4f6f373980e1ee5fd44fdfe539c",
  "transcript_text_chars": 79353,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9989848135332564,
    "text_chars": 79353,
    "completed_at": "2026-06-29 11:26:51"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:JMeXWVw0r3E
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/NR85H55eYkM/transcript.txt`
- 写入结果文件：`backfill/items/youtube/NR85H55eYkM/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:NR85H55eYkM",
  "platform": "youtube",
  "platform_id": "NR85H55eYkM",
  ...
  "published_at": "2025-07-27T11:00:38+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/NR85H55eYkM/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-07-28",
  "duration_seconds": 4304,
  "transcript_sha256": "78f86532d020c32142712b35ab5193b14ecf642662f03123ad214f1d4e468f96",
  "transcript_text_chars": 75469,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9986802973977694,
    "text_chars": 75469,
    "completed_at": "2026-06-29 08:18:39"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:NR85H55eYkM
```

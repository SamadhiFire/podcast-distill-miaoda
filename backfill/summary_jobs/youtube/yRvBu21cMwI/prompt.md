...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/yRvBu21cMwI/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/yRvBu21cMwI/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/yRvBu21cMwI/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:yRvBu21cMwI",
  "platform": "youtube",
  "platform_id": "yRvBu21cMwI",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/21/2025",
  "url": "https://www.youtube.com/watch?v=yRvBu21cMwI",
  "published_at": "2025-08-21T15:23:26+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/yRvBu21cMwI/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-22",
  "duration_seconds": 8650,
  "transcript_sha256": "301d8bf4c82921808abd08c947bfb01cd102ab637d73d1488d5483f4416c6ef3",
  "transcript_text_chars": 149630,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9975815028901734,
    "text_chars": 149630,
    "completed_at": "2026-06-29 09:23:56"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:yRvBu21cMwI
```

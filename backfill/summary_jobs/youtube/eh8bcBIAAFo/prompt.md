...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/eh8bcBIAAFo/transcript.txt`
- 写入结果文件：`backfill/items/youtube/eh8bcBIAAFo/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:eh8bcBIAAFo",
  "platform": "youtube",
  "platform_id": "eh8bcBIAAFo",
  ...
  "published_at": "2026-03-01T13:30:39+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/eh8bcBIAAFo/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-03-02",
  "duration_seconds": 4645,
  "transcript_sha256": "e519b4a8e07ec431072d66062a09fcffbb8a953a55668052d17b63c340844a4d",
  "transcript_text_chars": 83167,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992680301399355,
    "text_chars": 83167,
    "completed_at": "2026-06-29 12:54:55"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:eh8bcBIAAFo
```

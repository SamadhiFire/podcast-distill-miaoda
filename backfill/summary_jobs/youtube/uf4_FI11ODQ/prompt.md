...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/uf4_FI11ODQ/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/uf4_FI11ODQ/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/uf4_FI11ODQ/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:uf4_FI11ODQ",
  "platform": "youtube",
  "platform_id": "uf4_FI11ODQ",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Best Movies of the 21st Century: How the NYT List Was Made | The Daily",
  "url": "https://www.youtube.com/watch?v=uf4_FI11ODQ",
  "published_at": "2025-08-14T10:01:28+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/uf4_FI11ODQ/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-15",
  "duration_seconds": 1828,
  "transcript_sha256": "a6139956d9f3aa0242e02fb3721c2bbfcbe0f07878d88e38bff545c0ef642718",
  "transcript_text_chars": 28421,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.99195295404814,
    "text_chars": 28421,
    "completed_at": "2026-06-29 08:53:35"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:uf4_FI11ODQ
```

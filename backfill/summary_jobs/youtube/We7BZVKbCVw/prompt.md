...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/We7BZVKbCVw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/We7BZVKbCVw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:We7BZVKbCVw",
  "platform": "youtube",
  "platform_id": "We7BZVKbCVw",
  ...
  "published_at": "2026-02-19T13:30:28+00:00",
  "report_date": "2026-02-20",
  "duration_seconds": 5265,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/We7BZVKbCVw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-20",
  "duration_seconds": 5265,
  "transcript_sha256": "3baefa41da4e1019e5237bd293d540355817137e0f2a0bfd6b079f76da64de80",
  "transcript_text_chars": 101686,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992934472934473,
    "text_chars": 101686,
    "completed_at": "2026-06-29 12:48:46"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:We7BZVKbCVw
```

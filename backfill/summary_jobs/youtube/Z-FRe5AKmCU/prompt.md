...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Z-FRe5AKmCU/transcript.txt`
- 写入结果文件：`backfill/items/youtube/Z-FRe5AKmCU/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Z-FRe5AKmCU",
  "platform": "youtube",
  "platform_id": "Z-FRe5AKmCU",
  ...
  "published_at": "2026-01-13T20:06:59+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Z-FRe5AKmCU/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-01-14",
  "duration_seconds": 11179,
  "transcript_sha256": "3c144238d456f460d98f749ed881b7ff4db78d086f6ade83c3dfac69f4be8d81",
  "transcript_text_chars": 188355,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9990160121656678,
    "text_chars": 188355,
    "completed_at": "2026-06-29 12:24:33"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Z-FRe5AKmCU
```

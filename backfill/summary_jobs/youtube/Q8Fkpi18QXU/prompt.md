...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Q8Fkpi18QXU/transcript.txt`
- 写入结果文件：`backfill/items/youtube/Q8Fkpi18QXU/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Q8Fkpi18QXU",
  "platform": "youtube",
  "platform_id": "Q8Fkpi18QXU",
  ...
  "published_at": "2026-03-20T16:29:48+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Q8Fkpi18QXU/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-03-21",
  "duration_seconds": 5024,
  "transcript_sha256": "a4c25ada813816adaa76de897f294d1e679cdfbee6871ac3edef6ea91cd22151",
  "transcript_text_chars": 85854,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9997929936305733,
    "text_chars": 85854,
    "completed_at": "2026-06-29 13:09:28"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Q8Fkpi18QXU
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/ZttW75ys0BQ/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/ZttW75ys0BQ/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/ZttW75ys0BQ/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:ZttW75ys0BQ",
  "platform": "youtube",
  "platform_id": "ZttW75ys0BQ",
  "source_id": "yt_no_priors",
  "source_name": "No Priors Podcast",
  "category": "科技 / AI / VC",
  "title": "No Priors Ep. 126 | With Cloudfare CEO Matthew Prince",
  "url": "https://www.youtube.com/watch?v=ZttW75ys0BQ",
  "published_at": "2025-08-07T19:23:58+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/ZttW75ys0BQ/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-08",
  "duration_seconds": 2717,
  "transcript_sha256": "362b048587cf364fee098cf63f4ec18cf2dbdd8951a39e536cb76403b3bb5578",
  "transcript_text_chars": 48903,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9988553551711445,
    "text_chars": 48903,
    "completed_at": "2026-06-29 08:41:34"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:ZttW75ys0BQ
```

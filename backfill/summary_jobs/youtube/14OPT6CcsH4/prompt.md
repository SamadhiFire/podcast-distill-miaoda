...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/14OPT6CcsH4/transcript.txt`
- 写入结果文件：`backfill/items/youtube/14OPT6CcsH4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:14OPT6CcsH4",
  "platform": "youtube",
  "platform_id": "14OPT6CcsH4",
  ...
  "published_at": "2025-12-31T21:26:17+00:00",
  "report_date": "2026-01-01",
  "duration_seconds": 13938,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/14OPT6CcsH4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-01-01",
  "duration_seconds": 13938,
  "transcript_sha256": "a2010188893e2551ffe75aec923d51ec25f58f053dc29187284106dace728d54",
  "transcript_text_chars": 210061,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9991103458171905,
    "text_chars": 210061,
    "completed_at": "2026-06-29 12:17:13"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:14OPT6CcsH4
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/YbFYaCXIXeY/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/YbFYaCXIXeY/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/YbFYaCXIXeY/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:YbFYaCXIXeY",
  "platform": "youtube",
  "platform_id": "YbFYaCXIXeY",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "India's Modi to Meet China's Xi Amid US Tariff Tensions | The China Show 8/8/2025",
  "url": "https://www.youtube.com/watch?v=YbFYaCXIXeY",
  "published_at": "2025-08-08T05:39:35+00:00",
  "report_date": "2025-08-09",
  "duration_seconds": 5534,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/YbFYaCXIXeY/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-09",
  "duration_seconds": 5534,
  "transcript_sha256": "40e6f1f5ce7f3afd5b406bc16cf59fdf975e2833fd1b84af26094dbf071189ba",
  "transcript_text_chars": 89967,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9994434405493314,
    "text_chars": 89967,
    "completed_at": "2026-06-29 08:42:00"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:YbFYaCXIXeY
```

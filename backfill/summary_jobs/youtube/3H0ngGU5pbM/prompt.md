...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/3H0ngGU5pbM/transcript.txt`
- 写入结果文件：`backfill/items/youtube/3H0ngGU5pbM/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:3H0ngGU5pbM",
  "platform": "youtube",
  "platform_id": "3H0ngGU5pbM",
  ...
  "url": "https://www.youtube.com/watch?v=3H0ngGU5pbM",
  "published_at": "2025-11-13T13:30:04+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/3H0ngGU5pbM/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-11-14",
  "duration_seconds": 6834,
  "transcript_sha256": "5c230feabe8080680df837e94165d54add1bb054ace26d42b2aacb318e23643d",
  "transcript_text_chars": 135210,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992974831723733,
    "text_chars": 135210,
    "completed_at": "2026-06-29 11:42:45"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:3H0ngGU5pbM
```

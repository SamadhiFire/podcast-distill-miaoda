...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/YSa3alm-ZsA/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/YSa3alm-ZsA/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/YSa3alm-ZsA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:YSa3alm-ZsA",
  "platform": "youtube",
  "platform_id": "YSa3alm-ZsA",
  "source_id": "yt_wsj_take_on_week",
  "source_name": "WSJ Take On the Week",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Why This Barclays Analyst Says Retail Tariff Shock Hasn’t Hit Yet | WSJ’s Take On the Week",
  "url": "https://www.youtube.com/watch?v=YSa3alm-ZsA",
  "published_at": "2025-08-24T10:00:50+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/YSa3alm-ZsA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-25",
  "duration_seconds": 1384,
  "transcript_sha256": "b430d664c3eb5c0dd7675abf1d02b3c6c695d4a6b2d9ba4b456ae733084d28f5",
  "transcript_text_chars": 24084,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9940823699421965,
    "text_chars": 24084,
    "completed_at": "2026-06-29 09:28:51"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:YSa3alm-ZsA
```

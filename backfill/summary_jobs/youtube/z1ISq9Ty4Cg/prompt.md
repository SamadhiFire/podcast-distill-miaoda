...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/z1ISq9Ty4Cg/transcript.txt`
- 写入结果文件：`backfill/items/youtube/z1ISq9Ty4Cg/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:z1ISq9Ty4Cg",
  "platform": "youtube",
  "platform_id": "z1ISq9Ty4Cg",
  ...
  "url": "https://www.youtube.com/watch?v=z1ISq9Ty4Cg",
  "published_at": "2025-12-14T13:31:07+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/z1ISq9Ty4Cg/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-15",
  "duration_seconds": 5113,
  "transcript_sha256": "c31c336aa344ab161ac4bc86799e75d579f9f60078357df886a1132abb43e210",
  "transcript_text_chars": 96686,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9990690397027185,
    "text_chars": 96686,
    "completed_at": "2026-06-29 12:07:53"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:z1ISq9Ty4Cg
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/eKGNctKpx8w/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/eKGNctKpx8w/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/eKGNctKpx8w/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:eKGNctKpx8w",
  "platform": "youtube",
  "platform_id": "eKGNctKpx8w",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "What an LA Bakery Says About the Economy Right Now | Odd Lots",
  "url": "https://www.youtube.com/watch?v=eKGNctKpx8w",
  "published_at": "2025-08-01T13:58:31+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/eKGNctKpx8w/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-02",
  "duration_seconds": 2824,
  "transcript_sha256": "3ba8744d5dd20aabcb7216d9f9d1ee4a19f7169cec20f110c923e88d0e4b7c98",
  "transcript_text_chars": 45686,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9929461756373937,
    "text_chars": 45686,
    "completed_at": "2026-06-29 08:26:38"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:eKGNctKpx8w
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/J9982NLmTXg/transcript.txt`
- 写入结果文件：`backfill/items/youtube/J9982NLmTXg/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:J9982NLmTXg",
  "platform": "youtube",
  "platform_id": "J9982NLmTXg",
  ...
  "published_at": "2025-12-21T13:30:31+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/J9982NLmTXg/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-22",
  "duration_seconds": 5561,
  "transcript_sha256": "785fceb3eec65627f459073fdcc113c69f2ba5d929603120542269061d75bc4b",
  "transcript_text_chars": 82614,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9990721093328538,
    "text_chars": 82614,
    "completed_at": "2026-06-29 12:12:49"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:J9982NLmTXg
```

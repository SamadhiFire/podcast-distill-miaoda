...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/DZt1DDmMNGk/transcript.txt`
- 写入结果文件：`backfill/items/youtube/DZt1DDmMNGk/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:DZt1DDmMNGk",
  "platform": "youtube",
  "platform_id": "DZt1DDmMNGk",
  ...
  "published_at": "2026-06-09T12:00:33+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/DZt1DDmMNGk/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-06-10",
  "duration_seconds": 4810,
  "transcript_sha256": "0ddfcef319be54a8d8a6876685d07612f242bfdd356a3b39c670590e7847d97d",
  "transcript_text_chars": 71528,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.998935550935551,
    "text_chars": 71528,
    "completed_at": "2026-06-29 14:07:34"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:DZt1DDmMNGk
```

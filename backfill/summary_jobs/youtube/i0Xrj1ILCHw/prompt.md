...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/i0Xrj1ILCHw/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/i0Xrj1ILCHw/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/i0Xrj1ILCHw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:i0Xrj1ILCHw",
  "platform": "youtube",
  "platform_id": "i0Xrj1ILCHw",
  "source_id": "yt_bloomberg_originals",
  "source_name": "Bloomberg Originals",
  "category": "商业 / 财经 / 投资",
  "title": "How China’s Xiaomi Beat Apple and Is Taking on Tesla",
  "url": "https://www.youtube.com/watch?v=i0Xrj1ILCHw",
  "published_at": "2025-08-22T08:00:56+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/i0Xrj1ILCHw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-23",
  "duration_seconds": 581,
  "transcript_sha256": "63b4550f40013ccec73fc12537a69b1c95703828c6cd750f91c9f1997968f501",
  "transcript_text_chars": 7176,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9915318416523237,
    "text_chars": 7176,
    "completed_at": "2026-06-29 09:25:06"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:i0Xrj1ILCHw
```

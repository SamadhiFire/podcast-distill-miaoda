...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/g_oXZJEfzwc/transcript.txt`
- 写入结果文件：`backfill/items/youtube/g_oXZJEfzwc/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:g_oXZJEfzwc",
  "platform": "youtube",
  "platform_id": "g_oXZJEfzwc",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 7/21/2025",
  "url": "https://www.youtube.com/watch?v=g_oXZJEfzwc",
  "published_at": "2025-07-21T17:08:35+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/g_oXZJEfzwc/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-07-22",
  "duration_seconds": 8657,
  "transcript_sha256": "f47e7fa17cb5c9e8c93d5a8a4beab9ffd2a5b8204c25246a77890874c400c48d",
  "transcript_text_chars": 159994,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9993900889453621,
    "text_chars": 159994,
    "completed_at": "2026-06-29 08:10:10"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:g_oXZJEfzwc
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Zq1kW6xqRwg/transcript.txt`
- 写入结果文件：`backfill/items/youtube/Zq1kW6xqRwg/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Zq1kW6xqRwg",
  "platform": "youtube",
  "platform_id": "Zq1kW6xqRwg",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "A New Leader — and a New Showdown — at the Fed",
  "url": "https://www.youtube.com/watch?v=Zq1kW6xqRwg",
...
把下面 JSON 写入 `backfill/items/youtube/Zq1kW6xqRwg/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-15",
  "duration_seconds": 2139,
  "transcript_sha256": "ea957bfa6db6a61aa21f8496c3d5ad5cb43a69f12be51f09c59ce0940e537d2c",
  "transcript_text_chars": 31626,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9970565684899486,
    "text_chars": 31626,
    "completed_at": "2026-06-29 13:49:52"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Zq1kW6xqRwg
```

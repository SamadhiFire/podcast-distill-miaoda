...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/U8mCMe9MDpk/transcript.txt`
- 写入结果文件：`backfill/items/youtube/U8mCMe9MDpk/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:U8mCMe9MDpk",
  "platform": "youtube",
  "platform_id": "U8mCMe9MDpk",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Why One Lawyer Resigned When His Firm Caved to Trump: An Update",
  "url": "https://www.youtube.com/watch?v=U8mCMe9MDpk",
  "published_at": "2025-12-29T11:02:08+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/U8mCMe9MDpk/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-30",
  "duration_seconds": 1475,
  "transcript_sha256": "08e7575586ea76ddc6f45fd9e90c652186f239cf05d802d2d92e5d8bfe3e8675",
  "transcript_text_chars": 20147,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9935186440677967,
    "text_chars": 20147,
    "completed_at": "2026-06-29 12:16:12"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:U8mCMe9MDpk
```

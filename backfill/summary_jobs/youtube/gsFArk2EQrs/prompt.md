...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/gsFArk2EQrs/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/gsFArk2EQrs/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/gsFArk2EQrs/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:gsFArk2EQrs",
  "platform": "youtube",
  "platform_id": "gsFArk2EQrs",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Inside the A.I. Talent Wars",
  "url": "https://www.youtube.com/watch?v=gsFArk2EQrs",
  "published_at": "2025-08-25T14:16:21+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/gsFArk2EQrs/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-26",
  "duration_seconds": 1561,
  "transcript_sha256": "2e8ed96bc13aad75ac49bb214fbd5441dda92a1ad911ad6acf6dc8d32a6861d8",
  "transcript_text_chars": 22397,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.997713004484305,
    "text_chars": 22397,
    "completed_at": "2026-06-29 09:29:44"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:gsFArk2EQrs
```

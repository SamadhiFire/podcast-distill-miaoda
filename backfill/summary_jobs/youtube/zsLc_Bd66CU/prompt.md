...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/zsLc_Bd66CU/transcript.txt`
- 写入结果文件：`backfill/items/youtube/zsLc_Bd66CU/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:zsLc_Bd66CU",
  "platform": "youtube",
  "platform_id": "zsLc_Bd66CU",
  "source_id": "yt_bloomberg_originals",
  "source_name": "Bloomberg Originals",
  "category": "商业 / 财经 / 投资",
  "title": "Oracle, TikTok and That $455 Billion Surprise",
  "url": "https://www.youtube.com/watch?v=zsLc_Bd66CU",
  "published_at": "2025-09-19T08:01:24+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/zsLc_Bd66CU/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-20",
  "duration_seconds": 575,
  "transcript_sha256": "2075548a6590dca76fc00648bf6935769899fcaa1a121cb8024dabcc9a47c0f4",
  "transcript_text_chars": 8897,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9918086956521739,
    "text_chars": 8897,
    "completed_at": "2026-06-29 10:26:28"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:zsLc_Bd66CU
```

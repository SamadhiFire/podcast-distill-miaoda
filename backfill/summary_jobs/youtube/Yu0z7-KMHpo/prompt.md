...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Yu0z7-KMHpo/transcript.txt`
- 写入结果文件：`backfill/items/youtube/Yu0z7-KMHpo/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Yu0z7-KMHpo",
  "platform": "youtube",
  "platform_id": "Yu0z7-KMHpo",
  ...
  "published_at": "2026-06-16T14:00:06+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Yu0z7-KMHpo/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-06-17",
  "duration_seconds": 1774,
  "transcript_sha256": "3d700ed7b900a1b166d62e1dcdbfed8c09b297cda5d411a8928a48b443b2475b",
  "transcript_text_chars": 36050,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9990529875986471,
    "text_chars": 36050,
    "completed_at": "2026-06-29 14:13:04"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Yu0z7-KMHpo
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/TWIRPV1neEs/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/TWIRPV1neEs/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/TWIRPV1neEs/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:TWIRPV1neEs",
  "platform": "youtube",
  "platform_id": "TWIRPV1neEs",
  "source_id": "yt_cannonball",
  "source_name": "Cannonball with Wesley Morris",
  "category": "文化 / 社会 / 人文",
  "title": "The Greatest Summer Movies of 1990 vs. 2025 | Cannonball Podcast",
  "url": "https://www.youtube.com/watch?v=TWIRPV1neEs",
  "published_at": "2025-08-28T13:00:52+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/TWIRPV1neEs/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-29",
  "duration_seconds": 3128,
  "transcript_sha256": "1e42a7f34ed0c87175639b9deb90d4fdf0110d013472e5e351c8a7a38273a38f",
  "transcript_text_chars": 48785,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.994737851662404,
    "text_chars": 48785,
    "completed_at": "2026-06-29 09:38:43"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:TWIRPV1neEs
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/z7T1pCxgvlA/transcript.txt`
- 写入结果文件：`backfill/items/youtube/z7T1pCxgvlA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:z7T1pCxgvlA",
  "platform": "youtube",
  "platform_id": "z7T1pCxgvlA",
  ...
  "published_at": "2026-01-11T13:31:11+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/z7T1pCxgvlA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-01-12",
  "duration_seconds": 5183,
  "transcript_sha256": "80e434cf8161f581180ddc2e1c121d268bfa97972fecfd8cae6248a7b8d0d691",
  "transcript_text_chars": 89987,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9989426972795679,
    "text_chars": 89987,
    "completed_at": "2026-06-29 12:23:18"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:z7T1pCxgvlA
```

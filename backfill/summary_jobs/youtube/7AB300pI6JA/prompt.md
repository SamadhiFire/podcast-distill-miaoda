...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/7AB300pI6JA/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/7AB300pI6JA/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/7AB300pI6JA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:7AB300pI6JA",
  "platform": "youtube",
  "platform_id": "7AB300pI6JA",
  "source_id": "yt_the_interview_nyt",
  "source_name": "The Interview - New York Times",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Arundhati Roy: How to Survive Authoritarianism | The Interview",
  "url": "https://www.youtube.com/watch?v=7AB300pI6JA",
  "published_at": "2025-08-30T09:00:10+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/7AB300pI6JA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-31",
  "duration_seconds": 2553,
  "transcript_sha256": "e346363dbeaa29a0c208cf2bc64f0a76e7aa6e38baf38081ae9a94a86e311e15",
  "transcript_text_chars": 31349,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9970701135918527,
    "text_chars": 31349,
    "completed_at": "2026-06-29 09:43:05"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:7AB300pI6JA
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/6LDeJ4rlyyE/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/6LDeJ4rlyyE/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/6LDeJ4rlyyE/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:6LDeJ4rlyyE",
  "platform": "youtube",
  "platform_id": "6LDeJ4rlyyE",
  "source_id": "yt_interesting_times",
  "source_name": "Interesting Times with Ross Douthat",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Under Trump, Is Foreign Aid 'Our Problem?' | Interesting Times with Ross Douthat",
  "url": "https://www.youtube.com/watch?v=6LDeJ4rlyyE",
  "published_at": "2025-07-31T14:00:14+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/6LDeJ4rlyyE/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-01",
  "duration_seconds": 2795,
  "transcript_sha256": "49a0f3bc1cfc21b4008ba83f0a40f5f7e6b4273ca73f15894cebe033922003b7",
  "transcript_text_chars": 50720,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.994046511627907,
    "text_chars": 50720,
    "completed_at": "2026-06-29 08:24:11"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:6LDeJ4rlyyE
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/8m4mu1zCocs/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/8m4mu1zCocs/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/8m4mu1zCocs/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:8m4mu1zCocs",
  "platform": "youtube",
  "platform_id": "8m4mu1zCocs",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Trump’s Takeover of the Fed",
  "url": "https://www.youtube.com/watch?v=8m4mu1zCocs",
  "published_at": "2025-08-27T14:19:35+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/8m4mu1zCocs/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-28",
  "duration_seconds": 1645,
  "transcript_sha256": "c987183b9ea4192d33ecdd61940e56ec6cc35c20b33359ffb3fb8813166a89fb",
  "transcript_text_chars": 22524,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9950577507598783,
    "text_chars": 22524,
    "completed_at": "2026-06-29 09:36:14"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:8m4mu1zCocs
```

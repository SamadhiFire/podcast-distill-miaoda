...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/8mPnJ0pT_CM/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/8mPnJ0pT_CM/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/8mPnJ0pT_CM/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:8mPnJ0pT_CM",
  "platform": "youtube",
  "platform_id": "8mPnJ0pT_CM",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "Xiaomi Plans Europe Entry; Pop Mart Gets Labubu Boost | The China Show 8/20/2025",
  "url": "https://www.youtube.com/watch?v=8mPnJ0pT_CM",
  "published_at": "2025-08-20T06:00:41+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/8mPnJ0pT_CM/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-21",
  "duration_seconds": 5492,
  "transcript_sha256": "c5c51418bac62550beeab8076481807b3ffe25924181e6aed6413dc1b2179098",
  "transcript_text_chars": 95033,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9990203932993444,
    "text_chars": 95033,
    "completed_at": "2026-06-29 09:19:49"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:8mPnJ0pT_CM
```

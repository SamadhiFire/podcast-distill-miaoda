...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/j9KN7_4eBwA/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/j9KN7_4eBwA/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/j9KN7_4eBwA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:j9KN7_4eBwA",
  "platform": "youtube",
  "platform_id": "j9KN7_4eBwA",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/13/2025",
  "url": "https://www.youtube.com/watch?v=j9KN7_4eBwA",
  "published_at": "2025-08-13T16:13:52+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/j9KN7_4eBwA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-14",
  "duration_seconds": 8835,
  "transcript_sha256": "59f6fe7a69730b164c280078cda4a640409ff5b643583250a9a8cbb4d354c258",
  "transcript_text_chars": 159417,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9993887945670629,
    "text_chars": 159417,
    "completed_at": "2026-06-29 08:51:06"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:j9KN7_4eBwA
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/M__V1Fb7UaM/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/M__V1Fb7UaM/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/M__V1Fb7UaM/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:M__V1Fb7UaM",
  "platform": "youtube",
  "platform_id": "M__V1Fb7UaM",
  "source_id": "yt_wsj_bold_names",
  "source_name": "WSJ Bold Names",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Space Trucks: One Startup’s Plan to Get the U.S. Back on the Moon",
  "url": "https://www.youtube.com/watch?v=M__V1Fb7UaM",
  "published_at": "2025-08-08T12:08:33+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/M__V1Fb7UaM/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-09",
  "duration_seconds": 2853,
  "transcript_sha256": "4079156566f9d9cb989fe158891171e08defc4e93466fe0a73e8e45eccf92d51",
  "transcript_text_chars": 45001,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9979386610585349,
    "text_chars": 45001,
    "completed_at": "2026-06-29 08:42:53"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:M__V1Fb7UaM
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/AmyAexM6uXg/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/AmyAexM6uXg/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/AmyAexM6uXg/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:AmyAexM6uXg",
  "platform": "youtube",
  "platform_id": "AmyAexM6uXg",
  "source_id": "yt_cannonball",
  "source_name": "Cannonball with Wesley Morris",
  "category": "文化 / 社会 / 人文",
  "title": "Beyoncé Isn’t Giving Up on America: What We Saw on the Cowboy Carter Tour | Cannonball",
  "url": "https://www.youtube.com/watch?v=AmyAexM6uXg",
  "published_at": "2025-08-07T14:00:11+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/AmyAexM6uXg/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-08",
  "duration_seconds": 2895,
  "transcript_sha256": "e33af72544716be143f299bb7a117aa62af9356c575b197b670cfdef41fc4267",
  "transcript_text_chars": 44002,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9955889464594128,
    "text_chars": 44002,
    "completed_at": "2026-06-29 09:54:54"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:AmyAexM6uXg
```

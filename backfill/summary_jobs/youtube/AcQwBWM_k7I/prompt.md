...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/AcQwBWM_k7I/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/AcQwBWM_k7I/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/AcQwBWM_k7I/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:AcQwBWM_k7I",
  "platform": "youtube",
  "platform_id": "AcQwBWM_k7I",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "Nvidia, AMD to Pay US 15% of China AI Chip Sales | The China Show 8/11/2025",
  "url": "https://www.youtube.com/watch?v=AcQwBWM_k7I",
  "published_at": "2025-08-11T04:12:22+00:00",
  "report_date": "2025-08-12",
  "duration_seconds": 5479,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/AcQwBWM_k7I/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-12",
  "duration_seconds": 5479,
  "transcript_sha256": "ebca97e090b2cdd05ed1bf269570d5b7dd416c3b0a04c056936e9d16f5d06aea",
  "transcript_text_chars": 93815,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9993938674940682,
    "text_chars": 93815,
    "completed_at": "2026-06-29 08:45:53"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:AcQwBWM_k7I
```

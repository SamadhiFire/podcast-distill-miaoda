...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/twzLDx9iers/transcript.txt`
- 写入结果文件：`backfill/items/youtube/twzLDx9iers/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:twzLDx9iers",
  "platform": "youtube",
  "platform_id": "twzLDx9iers",
  ...
  "url": "https://www.youtube.com/watch?v=twzLDx9iers",
  "published_at": "2026-01-04T13:31:04+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/twzLDx9iers/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-01-05",
  "duration_seconds": 5517,
  "transcript_sha256": "969bb738370fb3acc40ea28079945462d05b981f970165176c7267c06e8f7c58",
  "transcript_text_chars": 96624,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9989777052746057,
    "text_chars": 96624,
    "completed_at": "2026-06-29 12:18:50"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:twzLDx9iers
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/SdMgOXfSBQw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/SdMgOXfSBQw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:SdMgOXfSBQw",
  "platform": "youtube",
  "platform_id": "SdMgOXfSBQw",
  ...
  "published_at": "2025-09-05T15:31:41+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/SdMgOXfSBQw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-06",
  "duration_seconds": 5768,
  "transcript_sha256": "5eb46f243272dd361b85f4c219230d74209f1e97c62d24b7382e44bb05c2ee87",
  "transcript_text_chars": 89917,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.999250866851595,
    "text_chars": 89917,
    "completed_at": "2026-06-29 09:53:15"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:SdMgOXfSBQw
```

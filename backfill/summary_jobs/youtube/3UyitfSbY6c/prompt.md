...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/3UyitfSbY6c/transcript.txt`
- 写入结果文件：`backfill/items/youtube/3UyitfSbY6c/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:3UyitfSbY6c",
  "platform": "youtube",
  "platform_id": "3UyitfSbY6c",
  ...
  "published_at": "2026-02-15T13:30:02+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/3UyitfSbY6c/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-16",
  "duration_seconds": 4477,
  "transcript_sha256": "c56102d37c28d707d015a983e60615ff2393c67955a6c7a4d4e650f55ec7548b",
  "transcript_text_chars": 75374,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992226937681484,
    "text_chars": 75374,
    "completed_at": "2026-06-29 12:47:08"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:3UyitfSbY6c
```

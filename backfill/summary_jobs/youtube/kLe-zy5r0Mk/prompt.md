...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/kLe-zy5r0Mk/transcript.txt`
- 写入结果文件：`backfill/items/youtube/kLe-zy5r0Mk/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:kLe-zy5r0Mk",
  "platform": "youtube",
  "platform_id": "kLe-zy5r0Mk",
  ...
  "published_at": "2025-11-20T14:01:21+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/kLe-zy5r0Mk/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-11-21",
  "duration_seconds": 5436,
  "transcript_sha256": "39d657f55627890f8cd5e68d30fd45ca7f570fa6e4f5d6f8f448db3d2a6d7a6f",
  "transcript_text_chars": 90876,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.998962472406181,
    "text_chars": 90876,
    "completed_at": "2026-06-29 11:49:57"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:kLe-zy5r0Mk
```

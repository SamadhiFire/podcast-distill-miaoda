...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/xvB3A9leAQ8/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/xvB3A9leAQ8/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/xvB3A9leAQ8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:xvB3A9leAQ8",
  "platform": "youtube",
  "platform_id": "xvB3A9leAQ8",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "Emi Nakamura on Central Bank Credibility and the Taylor Rule | Odd Lots",
  "url": "https://www.youtube.com/watch?v=xvB3A9leAQ8",
  "published_at": "2025-08-29T13:01:54+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/xvB3A9leAQ8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-30",
  "duration_seconds": 2185,
  "transcript_sha256": "999d799ea5daa91a5b6bdc0941ae141b07ee8c79ef53cc032e564ffdebc914ab",
  "transcript_text_chars": 37438,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9918352402745995,
    "text_chars": 37438,
    "completed_at": "2026-06-29 09:41:55"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:xvB3A9leAQ8
```

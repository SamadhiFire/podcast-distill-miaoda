...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/_9V_Hbe-N1A/transcript.txt`
- 写入结果文件：`backfill/items/youtube/_9V_Hbe-N1A/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:_9V_Hbe-N1A",
  "platform": "youtube",
  "platform_id": "_9V_Hbe-N1A",
  ...
  "published_at": "2025-12-30T17:32:19+00:00",
  "report_date": "2025-12-31",
  "duration_seconds": 6594,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/_9V_Hbe-N1A/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-31",
  "duration_seconds": 6594,
  "transcript_sha256": "98d791dbeef062df11ccc638c39491d3910b311c670b0f4c23758f3e0381ef87",
  "transcript_text_chars": 119221,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9994540491355778,
    "text_chars": 119221,
    "completed_at": "2026-06-29 12:16:49"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:_9V_Hbe-N1A
```

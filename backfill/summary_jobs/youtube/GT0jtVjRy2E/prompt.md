...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/GT0jtVjRy2E/transcript.txt`
- 写入结果文件：`backfill/items/youtube/GT0jtVjRy2E/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:GT0jtVjRy2E",
  "platform": "youtube",
  "platform_id": "GT0jtVjRy2E",
  ...
  "published_at": "2025-08-31T11:00:33+00:00",
  "report_date": "2025-09-01",
  "duration_seconds": 6042,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/GT0jtVjRy2E/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-01",
  "duration_seconds": 6042,
  "transcript_sha256": "77dedced92a4d9b3ee33ede756cc193dc23b330e03c7ca4d29c802adaa45c272",
  "transcript_text_chars": 107825,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9991127110228402,
    "text_chars": 107825,
    "completed_at": "2026-06-29 09:43:24"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:GT0jtVjRy2E
```

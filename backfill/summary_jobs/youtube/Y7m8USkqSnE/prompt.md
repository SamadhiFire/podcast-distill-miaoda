...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Y7m8USkqSnE/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Y7m8USkqSnE/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Y7m8USkqSnE/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Y7m8USkqSnE",
  "platform": "youtube",
  "platform_id": "Y7m8USkqSnE",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Why So Many Parents Are Opting Out of Public Schools",
  "url": "https://www.youtube.com/watch?v=Y7m8USkqSnE",
  "published_at": "2025-08-20T14:39:43+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Y7m8USkqSnE/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-21",
  "duration_seconds": 1776,
  "transcript_sha256": "b82cef173a4f0db4314a4cb7b59d9af05ecdc90799fc55f4db5ecae7c1466be7",
  "transcript_text_chars": 25143,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9973648648648649,
    "text_chars": 25143,
    "completed_at": "2026-06-29 09:20:31"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Y7m8USkqSnE
```

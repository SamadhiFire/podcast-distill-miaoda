...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Ir8E1rL1__g/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Ir8E1rL1__g/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Ir8E1rL1__g/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Ir8E1rL1__g",
  "platform": "youtube",
  "platform_id": "Ir8E1rL1__g",
  "source_id": "yt_the_interview_nyt",
  "source_name": "The Interview - New York Times",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Trump’s Secret Weapon, According to a Former Hostage Negotiator | The Interview",
  "url": "https://www.youtube.com/watch?v=Ir8E1rL1__g",
  "published_at": "2025-08-16T09:00:31+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Ir8E1rL1__g/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-17",
  "duration_seconds": 2392,
  "transcript_sha256": "c78c978b5924f28977bedf18da2dfaae1ff63aca9397db60f89f65f806a94cf9",
  "transcript_text_chars": 36673,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9912290969899665,
    "text_chars": 36673,
    "completed_at": "2026-06-29 09:00:15"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Ir8E1rL1__g
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/GlNFrhxke3E/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/GlNFrhxke3E/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/GlNFrhxke3E/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:GlNFrhxke3E",
  "platform": "youtube",
  "platform_id": "GlNFrhxke3E",
  "source_id": "yt_business_breakdowns",
  "source_name": "Business Breakdowns",
  "category": "商业 / 财经 / 投资",
  "title": "CME Group: The House Always Wins - [Business Breakdowns, EP.224]",
  "url": "https://www.youtube.com/watch?v=GlNFrhxke3E",
  "published_at": "2025-08-17T21:02:42+00:00",
  "report_date": "2025-08-18",
  "duration_seconds": 3624,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/GlNFrhxke3E/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-18",
  "duration_seconds": 3624,
  "transcript_sha256": "ea61322ccceac45f9867cadf76e0545886688d2a666e7af14c7fb1331505039b",
  "transcript_text_chars": 54412,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9987941501103753,
    "text_chars": 54412,
    "completed_at": "2026-06-29 09:05:35"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:GlNFrhxke3E
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Bin1qrEky-A/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Bin1qrEky-A/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Bin1qrEky-A/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Bin1qrEky-A",
  "platform": "youtube",
  "platform_id": "Bin1qrEky-A",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/19/2025",
  "url": "https://www.youtube.com/watch?v=Bin1qrEky-A",
  "published_at": "2025-08-19T16:23:56+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Bin1qrEky-A/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-20",
  "duration_seconds": 8660,
  "transcript_sha256": "24ac181675531941fc981b6b78bebfc2c9304882553078dfbc17a835864b6ef5",
  "transcript_text_chars": 158671,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9998868360277137,
    "text_chars": 158671,
    "completed_at": "2026-06-29 09:19:29"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Bin1qrEky-A
```

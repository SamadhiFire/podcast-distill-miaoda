...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/j36xucDSsZc/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/j36xucDSsZc/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/j36xucDSsZc/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:j36xucDSsZc",
  "platform": "youtube",
  "platform_id": "j36xucDSsZc",
  "source_id": "yt_interesting_times",
  "source_name": "Interesting Times with Ross Douthat",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Ross and Ezra Klein Discuss Trump, Mysticism and Psychedelics | Interesting Times with Ross Douthat",
  "url": "https://www.youtube.com/watch?v=j36xucDSsZc",
  "published_at": "2025-08-21T14:13:24+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/j36xucDSsZc/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-22",
  "duration_seconds": 5773,
  "transcript_sha256": "324a8b7b5eb60805e36b18bc0212a5907737a1824c07875ca719c36dcdece231",
  "transcript_text_chars": 89531,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.998135977827819,
    "text_chars": 89531,
    "completed_at": "2026-06-29 09:23:16"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:j36xucDSsZc
```

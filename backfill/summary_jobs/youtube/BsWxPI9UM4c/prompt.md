...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/BsWxPI9UM4c/transcript.txt`
- 写入结果文件：`backfill/items/youtube/BsWxPI9UM4c/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:BsWxPI9UM4c",
  "platform": "youtube",
  "platform_id": "BsWxPI9UM4c",
  ...
  "published_at": "2025-09-25T11:00:31+00:00",
  "report_date": "2025-09-26",
  "duration_seconds": 6393,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/BsWxPI9UM4c/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-26",
  "duration_seconds": 6393,
  "transcript_sha256": "35aa66de0caadacc1433ff982d03c7bdb1bd55c46338a6f07246fda1515325fd",
  "transcript_text_chars": 102304,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9991928671984984,
    "text_chars": 102304,
    "completed_at": "2026-06-29 10:35:54"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:BsWxPI9UM4c
```

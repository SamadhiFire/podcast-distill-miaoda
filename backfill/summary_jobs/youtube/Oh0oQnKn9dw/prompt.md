...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Oh0oQnKn9dw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/Oh0oQnKn9dw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Oh0oQnKn9dw",
  "platform": "youtube",
  "platform_id": "Oh0oQnKn9dw",
  "source_id": "yt_no_priors",
  "source_name": "No Priors Podcast",
  "category": "科技 / AI / VC",
  "title": "No Priors Ep. 135 | With Humans& Founder Eric Zelikman",
  "url": "https://www.youtube.com/watch?v=Oh0oQnKn9dw",
  "published_at": "2025-10-09T07:00:19+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Oh0oQnKn9dw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-10-10",
  "duration_seconds": 2219,
  "transcript_sha256": "fdeb5c632704bb24b97febffa279f5ae1e7a45eb5bd4b31ec31997269a4d775e",
  "transcript_text_chars": 36156,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9977823343848581,
    "text_chars": 36156,
    "completed_at": "2026-06-29 11:13:31"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Oh0oQnKn9dw
```

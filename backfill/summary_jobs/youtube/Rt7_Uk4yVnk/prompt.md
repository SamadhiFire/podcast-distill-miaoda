...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Rt7_Uk4yVnk/transcript.txt`
- 写入结果文件：`backfill/items/youtube/Rt7_Uk4yVnk/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Rt7_Uk4yVnk",
  "platform": "youtube",
  "platform_id": "Rt7_Uk4yVnk",
  ...
  "published_at": "2025-10-21T12:00:56+00:00",
  "report_date": "2025-10-22",
  "duration_seconds": 6383,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/Rt7_Uk4yVnk/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-10-22",
  "duration_seconds": 6383,
  "transcript_sha256": "98878480ae07834db2130acedde9e79763b8ae81104ad89ee646dd7dd422712a",
  "transcript_text_chars": 104988,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9997681341062197,
    "text_chars": 104988,
    "completed_at": "2026-06-29 11:22:20"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Rt7_Uk4yVnk
```

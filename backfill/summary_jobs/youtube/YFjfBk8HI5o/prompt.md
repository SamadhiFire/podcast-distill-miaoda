...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/YFjfBk8HI5o/transcript.txt`
- 写入结果文件：`backfill/items/youtube/YFjfBk8HI5o/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:YFjfBk8HI5o",
  "platform": "youtube",
  "platform_id": "YFjfBk8HI5o",
  ...
  "published_at": "2026-02-12T03:07:03+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/YFjfBk8HI5o/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-13",
  "duration_seconds": 11752,
  "transcript_sha256": "794a1d6042d9f3c34a300c8b4fdda110f906073f03665a25ebdf4d29935d7aa5",
  "transcript_text_chars": 158641,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9989550714771953,
    "text_chars": 158641,
    "completed_at": "2026-06-29 12:43:44"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:YFjfBk8HI5o
```

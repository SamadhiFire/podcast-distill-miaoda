...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/x2VHFgyawPE/transcript.txt`
- 写入结果文件：`backfill/items/youtube/x2VHFgyawPE/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:x2VHFgyawPE",
  "platform": "youtube",
  "platform_id": "x2VHFgyawPE",
  ...
  "published_at": "2026-06-17T12:00:14+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/x2VHFgyawPE/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-06-18",
  "duration_seconds": 4205,
  "transcript_sha256": "2ca5d00aced8fc284bd6524fbdb78c67eb8f997880fe21b126c445b9e6461b7b",
  "transcript_text_chars": 73691,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9976986920332938,
    "text_chars": 73691,
    "completed_at": "2026-06-29 14:14:08"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:x2VHFgyawPE
```

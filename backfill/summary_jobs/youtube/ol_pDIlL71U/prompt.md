...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/ol_pDIlL71U/transcript.txt`
- 写入结果文件：`backfill/items/youtube/ol_pDIlL71U/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:ol_pDIlL71U",
  "platform": "youtube",
  "platform_id": "ol_pDIlL71U",
  ...
  "published_at": "2025-09-25T10:01:35+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/ol_pDIlL71U/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-26",
  "duration_seconds": 3710,
  "transcript_sha256": "54aae179fa883c9f579000d7b2893e718834dbfcbfc0969dda9490e26b380c22",
  "transcript_text_chars": 64811,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9983611859838275,
    "text_chars": 64811,
    "completed_at": "2026-06-29 10:35:55"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:ol_pDIlL71U
```

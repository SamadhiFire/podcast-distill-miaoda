...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/KkT7jxRJs8E/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/KkT7jxRJs8E/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/KkT7jxRJs8E/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:KkT7jxRJs8E",
  "platform": "youtube",
  "platform_id": "KkT7jxRJs8E",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Zelensky Survives Second Oval Office Meeting",
  "url": "https://www.youtube.com/watch?v=KkT7jxRJs8E",
  "published_at": "2025-08-19T14:21:18+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/KkT7jxRJs8E/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-20",
  "duration_seconds": 1825,
  "transcript_sha256": "69bf67950d78255deb146d9083f039347ecf1316a6cd0bc2546ec2977114d435",
  "transcript_text_chars": 27254,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9981479452054794,
    "text_chars": 27254,
    "completed_at": "2026-06-29 09:18:36"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:KkT7jxRJs8E
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/sRKBGVFVYAw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/sRKBGVFVYAw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:sRKBGVFVYAw",
  "platform": "youtube",
  "platform_id": "sRKBGVFVYAw",
  ...
  "published_at": "2026-05-08T17:09:45+00:00",
  "report_date": "2026-05-09",
  "duration_seconds": 8030,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/sRKBGVFVYAw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-09",
  "duration_seconds": 8030,
  "transcript_sha256": "241646c9641c87a9b0a485ed9823c988a560dacbac5577c99ecc3025997f57a0",
  "transcript_text_chars": 137162,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9997808219178081,
    "text_chars": 137162,
    "completed_at": "2026-06-29 13:45:20"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:sRKBGVFVYAw
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/g45Alfg7diw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/g45Alfg7diw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:g45Alfg7diw",
  "platform": "youtube",
  "platform_id": "g45Alfg7diw",
  ...
  "published_at": "2026-03-24T12:01:12+00:00",
  "report_date": "2026-03-25",
  "duration_seconds": 3508,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/g45Alfg7diw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-03-25",
  "duration_seconds": 3508,
  "transcript_sha256": "ceaccebc0d739f946d260c738cf961352203e0955c755670bf90013050040255",
  "transcript_text_chars": 67092,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9980088369441277,
    "text_chars": 67092,
    "completed_at": "2026-06-29 13:11:03"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:g45Alfg7diw
```

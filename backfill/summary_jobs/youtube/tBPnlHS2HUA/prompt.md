...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/tBPnlHS2HUA/transcript.txt`
- 写入结果文件：`backfill/items/youtube/tBPnlHS2HUA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:tBPnlHS2HUA",
  "platform": "youtube",
  "platform_id": "tBPnlHS2HUA",
  ...
  "url": "https://www.youtube.com/watch?v=tBPnlHS2HUA",
  "published_at": "2025-09-02T09:01:27+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/tBPnlHS2HUA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-03",
  "duration_seconds": 3000,
  "transcript_sha256": "0e889cf70fa732ca5fe3143c8fbbaf9a943eb0a107b38f2cbca4c03b9d468c2b",
  "transcript_text_chars": 55117,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.99534,
    "text_chars": 55117,
    "completed_at": "2026-06-29 09:44:46"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:tBPnlHS2HUA
```

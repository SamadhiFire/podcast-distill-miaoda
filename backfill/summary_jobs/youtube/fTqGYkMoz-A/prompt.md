...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/fTqGYkMoz-A/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/fTqGYkMoz-A/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/fTqGYkMoz-A/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:fTqGYkMoz-A",
  "platform": "youtube",
  "platform_id": "fTqGYkMoz-A",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "Lessons From A Sovereign Wealth Fund in the United States | Odd Lots (Correct)",
  "url": "https://www.youtube.com/watch?v=fTqGYkMoz-A",
  "published_at": "2025-08-18T15:15:10+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/fTqGYkMoz-A/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-19",
  "duration_seconds": 2812,
  "transcript_sha256": "1578ad88cb52cce5a6cdff5b74eb560fd1053298d7ffae6e1a8253467075bf2e",
  "transcript_text_chars": 43922,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9918136557610242,
    "text_chars": 43922,
    "completed_at": "2026-06-29 09:08:56"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:fTqGYkMoz-A
```

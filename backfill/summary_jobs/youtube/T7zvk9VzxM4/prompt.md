...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/T7zvk9VzxM4/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/T7zvk9VzxM4/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/T7zvk9VzxM4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:T7zvk9VzxM4",
  "platform": "youtube",
  "platform_id": "T7zvk9VzxM4",
  "source_id": "yt_business_breakdowns",
  "source_name": "Business Breakdowns",
  "category": "商业 / 财经 / 投资",
  "title": "Compass: Real Estate Revolution - [Business Breakdowns, EP.226]",
  "url": "https://www.youtube.com/watch?v=T7zvk9VzxM4",
  "published_at": "2025-08-17T21:01:25+00:00",
  "report_date": "2025-08-18",
  "duration_seconds": 3772,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/T7zvk9VzxM4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-18",
  "duration_seconds": 3772,
  "transcript_sha256": "b0dd0b0eea01e2f98dddd1b9e6c630114be338ba295edb319949b56fdef1f599",
  "transcript_text_chars": 52011,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9986161187698834,
    "text_chars": 52011,
    "completed_at": "2026-06-29 09:04:43"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:T7zvk9VzxM4
```

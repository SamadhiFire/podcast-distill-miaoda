...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/AFpeWo1GTeg/transcript.txt`
- 写入结果文件：`backfill/items/youtube/AFpeWo1GTeg/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:AFpeWo1GTeg",
  "platform": "youtube",
  "platform_id": "AFpeWo1GTeg",
  ...
  "published_at": "2026-04-29T15:20:44+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/AFpeWo1GTeg/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-04-30",
  "duration_seconds": 1612,
  "transcript_sha256": "8922c9a45edc12fdd6a45aff80051d51ef69b17bdc4f5eecc0950e36183c9b91",
  "transcript_text_chars": 27609,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9959199751861042,
    "text_chars": 27609,
    "completed_at": "2026-06-29 13:34:59"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:AFpeWo1GTeg
```

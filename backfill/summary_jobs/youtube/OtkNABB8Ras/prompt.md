...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/OtkNABB8Ras/transcript.txt`
- 写入结果文件：`backfill/items/youtube/OtkNABB8Ras/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:OtkNABB8Ras",
  "platform": "youtube",
  "platform_id": "OtkNABB8Ras",
  ...
  "published_at": "2026-05-22T08:00:39+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/OtkNABB8Ras/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-23",
  "duration_seconds": 676,
  "transcript_sha256": "377d18633a4503a5cef9e0d11e1e5bc4f2879b42f92ebee555181d7d159c667b",
  "transcript_text_chars": 10694,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9863860946745563,
    "text_chars": 10694,
    "completed_at": "2026-06-29 13:55:58"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:OtkNABB8Ras
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/-7Yol5vX5xw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/-7Yol5vX5xw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:-7Yol5vX5xw",
  "platform": "youtube",
  "platform_id": "-7Yol5vX5xw",
  ...
  "published_at": "2026-04-26T12:30:00+00:00",
  "report_date": "2026-04-27",
  "duration_seconds": 4225,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/-7Yol5vX5xw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-04-27",
  "duration_seconds": 4225,
  "transcript_sha256": "2c3b0b85b5f5e24036c9d00984bfff1ad4905e11c8fd1ece4fa90dbc6efbd851",
  "transcript_text_chars": 80872,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9991100591715976,
    "text_chars": 80872,
    "completed_at": "2026-06-29 13:32:42"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:-7Yol5vX5xw
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/qkVYcMo_xdQ/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/qkVYcMo_xdQ/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/qkVYcMo_xdQ/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:qkVYcMo_xdQ",
  "platform": "youtube",
  "platform_id": "qkVYcMo_xdQ",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "Fierce AI Competition Pressures Baidu Revenue | The China Show 8/21/2025",
  "url": "https://www.youtube.com/watch?v=qkVYcMo_xdQ",
  "published_at": "2025-08-21T06:28:01+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/qkVYcMo_xdQ/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-22",
  "duration_seconds": 5491,
  "transcript_sha256": "9806bed0d15032ff2ea1f5a2047cc394f9d4f3d354488dff67f23e436646b6d1",
  "transcript_text_chars": 91066,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9995410672008741,
    "text_chars": 91066,
    "completed_at": "2026-06-29 09:21:51"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:qkVYcMo_xdQ
```

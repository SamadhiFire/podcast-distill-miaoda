...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/8-boBsWcr5A/transcript.txt`
- 写入结果文件：`backfill/items/youtube/8-boBsWcr5A/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:8-boBsWcr5A",
  "platform": "youtube",
  "platform_id": "8-boBsWcr5A",
  ...
  "published_at": "2025-11-12T17:02:10+00:00",
  "report_date": "2025-11-13",
  "duration_seconds": 5322,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/8-boBsWcr5A/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-11-13",
  "duration_seconds": 5322,
  "transcript_sha256": "7d51a8c80f3aa172b3776390b00fdef8a534f11bca673f30e1efe05ea16680b0",
  "transcript_text_chars": 89366,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992933107854189,
    "text_chars": 89366,
    "completed_at": "2026-06-29 11:41:50"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:8-boBsWcr5A
```

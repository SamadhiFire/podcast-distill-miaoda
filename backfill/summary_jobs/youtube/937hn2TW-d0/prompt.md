...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/937hn2TW-d0/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/937hn2TW-d0/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/937hn2TW-d0/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:937hn2TW-d0",
  "platform": "youtube",
  "platform_id": "937hn2TW-d0",
  "source_id": "yt_invest_like_best",
  "source_name": "Invest Like The Best",
  "category": "商业 / 财经 / 投资",
  "title": "The CEO Who Cheated Death, Slept an Hour a Night, and Built a Healthcare Empire",
  "url": "https://www.youtube.com/watch?v=937hn2TW-d0",
  "published_at": "2025-08-19T12:30:12+00:00",
  "report_date": "2025-08-20",
  "duration_seconds": 6041,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/937hn2TW-d0/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-20",
  "duration_seconds": 6041,
  "transcript_sha256": "8fa680b566dfd4221496d5a579cef5815be2fe1428b1e56b127351e9a0499676",
  "transcript_text_chars": 102599,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9987750372454892,
    "text_chars": 102599,
    "completed_at": "2026-06-29 09:17:57"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:937hn2TW-d0
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Px3R8Ntev8E/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Px3R8Ntev8E/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Px3R8Ntev8E/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Px3R8Ntev8E",
  "platform": "youtube",
  "platform_id": "Px3R8Ntev8E",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "China Stock Rally Gains Momentum | The China Show 8/18/2025",
  "url": "https://www.youtube.com/watch?v=Px3R8Ntev8E",
  "published_at": "2025-08-18T05:59:42+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Px3R8Ntev8E/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-19",
  "duration_seconds": 5557,
  "transcript_sha256": "3ca8a42cfe8f75fe62105b0966c8eb9288c656d17d072bc46f970a7b61f3a642",
  "transcript_text_chars": 96235,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9995069281986684,
    "text_chars": 96235,
    "completed_at": "2026-06-29 09:07:17"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Px3R8Ntev8E
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/dFxRzEohW6I/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/dFxRzEohW6I/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/dFxRzEohW6I/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:dFxRzEohW6I",
  "platform": "youtube",
  "platform_id": "dFxRzEohW6I",
  "source_id": "yt_bloomberg_originals",
  "source_name": "Bloomberg Originals",
  "category": "商业 / 财经 / 投资",
  "title": "A Last Ride in NYC's Disappearing Horse Elevators",
  "url": "https://www.youtube.com/watch?v=dFxRzEohW6I",
  "published_at": "2025-08-11T08:00:57+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/dFxRzEohW6I/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-12",
  "duration_seconds": 720,
  "transcript_sha256": "b55d38252794918a6201e5b7705de41c9cf0247411cf6cdda8c7dcb6c8f2d9c4",
  "transcript_text_chars": 7957,
  "extraction": {
    "method": "youtube_transcript_api",
    "language": "en",
    "coverage_ratio": 0.9464305555555554,
    "text_chars": 7957,
    "completed_at": "2026-06-30 02:21:43"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:dFxRzEohW6I
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/izTV0Tm63e8/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/izTV0Tm63e8/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/izTV0Tm63e8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:izTV0Tm63e8",
  "platform": "youtube",
  "platform_id": "izTV0Tm63e8",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "China’s Economy Slows Sharply | The China Show 8/15/2025",
  "url": "https://www.youtube.com/watch?v=izTV0Tm63e8",
  "published_at": "2025-08-15T05:40:56+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/izTV0Tm63e8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-16",
  "duration_seconds": 5490,
  "transcript_sha256": "336190ccc400fe7093a2455c35a27e9155f2d053ddf7052d04fec92536db927a",
  "transcript_text_chars": 84197,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9984408014571948,
    "text_chars": 84197,
    "completed_at": "2026-06-29 08:57:15"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:izTV0Tm63e8
```

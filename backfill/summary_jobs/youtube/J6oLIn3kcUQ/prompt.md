...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/J6oLIn3kcUQ/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/J6oLIn3kcUQ/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/J6oLIn3kcUQ/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:J6oLIn3kcUQ",
  "platform": "youtube",
  "platform_id": "J6oLIn3kcUQ",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "How to Move Freight Across the Icy Roads of Alaska | Odd Lots",
  "url": "https://www.youtube.com/watch?v=J6oLIn3kcUQ",
  "published_at": "2025-08-13T14:09:04+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/J6oLIn3kcUQ/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-14",
  "duration_seconds": 2334,
  "transcript_sha256": "0e71cca89eea10e7aa58fd3ec1b05e1c18370bdfd499c3ee0515f0a0f0e34574",
  "transcript_text_chars": 41749,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9857412167952013,
    "text_chars": 41749,
    "completed_at": "2026-06-29 08:50:11"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:J6oLIn3kcUQ
```

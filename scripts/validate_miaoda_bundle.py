#!/usr/bin/env python3
"""Validate Miaoda daily artifacts before report generation and publishing."""
...
def main() -> int:
    ...
    if warnings:
        ...
        for warning in warnings:
            print(f"- {warning}")
    if failures:
        print("Miaoda artifact validation failed:", file=sys.stderr)
        for failure in failures:
            print(f"- {failure}", file=sys.stderr)
        return 1

    print(
        "Miaoda artifacts validated: "

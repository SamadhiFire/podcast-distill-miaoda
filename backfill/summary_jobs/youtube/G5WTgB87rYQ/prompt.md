...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/G5WTgB87rYQ/transcript.txt`
- 写入结果文件：`backfill/items/youtube/G5WTgB87rYQ/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:G5WTgB87rYQ",
  "platform": "youtube",
  "platform_id": "G5WTgB87rYQ",
  ...
  "published_at": "2026-05-17T12:30:17+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/G5WTgB87rYQ/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-18",
  "duration_seconds": 5951,
  "transcript_sha256": "611e52cea196c13de01439011b902f77f455af4be71efc43c7fba738d16afb3e",
  "transcript_text_chars": 102186,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9993345656192236,
    "text_chars": 102186,
    "completed_at": "2026-06-29 13:52:07"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:G5WTgB87rYQ
```

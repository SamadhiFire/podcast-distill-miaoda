...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/n1E9IZfvGMA/transcript.txt`
- 写入结果文件：`backfill/items/youtube/n1E9IZfvGMA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:n1E9IZfvGMA",
  "platform": "youtube",
  "platform_id": "n1E9IZfvGMA",
  ...
  "published_at": "2026-02-13T17:11:03+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/n1E9IZfvGMA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-14",
  "duration_seconds": 8540,
  "transcript_sha256": "f727e7ada3d42ba0abd993fc2c60976bdd25d4bae16517545a58524f8a43de59",
  "transcript_text_chars": 150084,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9996346604215456,
    "text_chars": 150084,
    "completed_at": "2026-06-29 12:46:19"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:n1E9IZfvGMA
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/oG_-lBwzuhc/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/oG_-lBwzuhc/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/oG_-lBwzuhc/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:oG_-lBwzuhc",
  "platform": "youtube",
  "platform_id": "oG_-lBwzuhc",
  "source_id": "yt_sequoia",
  "source_name": "Sequoia Capital",
  "category": "科技 / AI / VC",
  "title": "Scaling the 'Cursor for Slides' to $50M ARR ft Gamma founder Jon Noronha",
  "url": "https://www.youtube.com/watch?v=oG_-lBwzuhc",
  "published_at": "2025-08-19T09:01:15+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/oG_-lBwzuhc/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-20",
  "duration_seconds": 1806,
  "transcript_sha256": "7695aafcfa718570d540ed7fdd3365ef9623ce15e3ee6d953c8f76465439df0e",
  "transcript_text_chars": 34832,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9920598006644519,
    "text_chars": 34832,
    "completed_at": "2026-06-29 09:17:03"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:oG_-lBwzuhc
```

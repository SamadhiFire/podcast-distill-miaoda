...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/yBzStBK6Z8c/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/yBzStBK6Z8c/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/yBzStBK6Z8c/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:yBzStBK6Z8c",
  "platform": "youtube",
  "platform_id": "yBzStBK6Z8c",
  "source_id": "yt_openai_podcast",
  "source_name": "The OpenAI Podcast",
  "category": "科技 / AI / VC",
  ...
  "published_at": "2025-08-15T16:01:44+00:00",
  "report_date": "2025-08-16",
  "duration_seconds": 2424,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/yBzStBK6Z8c/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-16",
  "duration_seconds": 2424,
  "transcript_sha256": "0983ee6844e3f6dd65fcb81234d48b4d0bdfc6fc0b4812092e52ebbeef45e6d9",
  "transcript_text_chars": 38880,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9989768976897689,
    "text_chars": 38880,
    "completed_at": "2026-06-29 08:59:04"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:yBzStBK6Z8c
```

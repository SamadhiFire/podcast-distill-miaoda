...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/EEIPtofVe2Q/transcript.txt`
- 写入结果文件：`backfill/items/youtube/EEIPtofVe2Q/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:EEIPtofVe2Q",
  "platform": "youtube",
  "platform_id": "EEIPtofVe2Q",
  ...
  "published_at": "2025-07-30T09:00:27+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/EEIPtofVe2Q/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-07-31",
  "duration_seconds": 1811,
  "transcript_sha256": "58b3e858529cc72b2cb125e1951b08bb1e0e129ec38e2fa41df94ec92c177535",
  "transcript_text_chars": 31666,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9952236333517394,
    "text_chars": 31666,
    "completed_at": "2026-06-29 08:21:50"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:EEIPtofVe2Q
```

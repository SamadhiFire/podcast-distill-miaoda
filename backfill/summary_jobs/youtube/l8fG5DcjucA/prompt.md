...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/l8fG5DcjucA/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/l8fG5DcjucA/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/l8fG5DcjucA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:l8fG5DcjucA",
  "platform": "youtube",
  "platform_id": "l8fG5DcjucA",
  "source_id": "yt_no_priors",
  "source_name": "No Priors Podcast",
  "category": "科技 / AI / VC",
  "title": "No Priors Ep. 125 | With Senior White House Policy Advisor on AI Sriram Krishnan",
  "url": "https://www.youtube.com/watch?v=l8fG5DcjucA",
  "published_at": "2025-07-31T10:01:19+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/l8fG5DcjucA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-01",
  "duration_seconds": 2208,
  "transcript_sha256": "c1a174aae4005067cb6e8a4ab6ccdefd8feb1e0bc50e4166fc37001c38430bde",
  "transcript_text_chars": 42127,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9979347826086957,
    "text_chars": 42127,
    "completed_at": "2026-06-29 08:23:22"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:l8fG5DcjucA
```

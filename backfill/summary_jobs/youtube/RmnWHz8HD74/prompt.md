...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/RmnWHz8HD74/transcript.txt`
- 写入结果文件：`backfill/items/youtube/RmnWHz8HD74/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:RmnWHz8HD74",
  "platform": "youtube",
  "platform_id": "RmnWHz8HD74",
  ...
  "published_at": "2025-11-30T12:00:53+00:00",
  "report_date": "2025-12-01",
  "duration_seconds": 5162,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/RmnWHz8HD74/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-01",
  "duration_seconds": 5162,
  "transcript_sha256": "8dd4ffe2c1310b801cdbb1508908cf046606fa59f2ddddb3b9d602355e856341",
  "transcript_text_chars": 83731,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9990081363812476,
    "text_chars": 83731,
    "completed_at": "2026-06-29 11:56:06"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:RmnWHz8HD74
```

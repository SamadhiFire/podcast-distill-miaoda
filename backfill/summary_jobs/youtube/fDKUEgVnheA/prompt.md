...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/fDKUEgVnheA/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/fDKUEgVnheA/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/fDKUEgVnheA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:fDKUEgVnheA",
  "platform": "youtube",
  "platform_id": "fDKUEgVnheA",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "China's Meituan Warns of Losses From Price War | The China Show 8/28/2025",
  "url": "https://www.youtube.com/watch?v=fDKUEgVnheA",
  "published_at": "2025-08-28T05:33:43+00:00",
  "report_date": "2025-08-29",
  "duration_seconds": 5537,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/fDKUEgVnheA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-29",
  "duration_seconds": 5537,
  "transcript_sha256": "7aa447705124394a3102be759710bdb8622a7c6dcc5e72799d15c1650e35498e",
  "transcript_text_chars": 93822,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9982084161098067,
    "text_chars": 93822,
    "completed_at": "2026-06-29 09:37:19"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:fDKUEgVnheA
```

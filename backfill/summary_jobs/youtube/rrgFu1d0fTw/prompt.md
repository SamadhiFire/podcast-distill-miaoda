...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/rrgFu1d0fTw/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/rrgFu1d0fTw/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/rrgFu1d0fTw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:rrgFu1d0fTw",
  "platform": "youtube",
  "platform_id": "rrgFu1d0fTw",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "Kansas City's Fed President on What Everyone Will Be Talking About at Jackson Hole | Odd Lots",
  "url": "https://www.youtube.com/watch?v=rrgFu1d0fTw",
  "published_at": "2025-08-21T15:59:38+00:00",
  "report_date": "2025-08-22",
  "duration_seconds": 3022,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/rrgFu1d0fTw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-22",
  "duration_seconds": 3022,
  "transcript_sha256": "ec7445a897aa8f35fa960324e8869b813846a2f86d5bd9d4115fafd675aef355",
  "transcript_text_chars": 47095,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9988021178027796,
    "text_chars": 47095,
    "completed_at": "2026-06-29 09:24:10"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:rrgFu1d0fTw
```

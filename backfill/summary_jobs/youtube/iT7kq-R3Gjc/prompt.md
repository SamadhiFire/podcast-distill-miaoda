...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/iT7kq-R3Gjc/transcript.txt`
- 写入结果文件：`backfill/items/youtube/iT7kq-R3Gjc/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:iT7kq-R3Gjc",
  "platform": "youtube",
  "platform_id": "iT7kq-R3Gjc",
  ...
  "published_at": "2025-09-14T11:01:12+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/iT7kq-R3Gjc/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-15",
  "duration_seconds": 4316,
  "transcript_sha256": "668239dec327f8c1ea75fd95733c040fb9e462b5b55c5110c3c83295ad857b32",
  "transcript_text_chars": 76959,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9986839666357737,
    "text_chars": 76959,
    "completed_at": "2026-06-29 10:13:05"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:iT7kq-R3Gjc
```

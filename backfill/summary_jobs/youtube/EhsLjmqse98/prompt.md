...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/EhsLjmqse98/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/EhsLjmqse98/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/EhsLjmqse98/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:EhsLjmqse98",
  "platform": "youtube",
  "platform_id": "EhsLjmqse98",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "Bill Beach on How Trump Just Politicized US Economic Data | Odd Lots",
  "url": "https://www.youtube.com/watch?v=EhsLjmqse98",
  "published_at": "2025-08-05T14:31:42+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/EhsLjmqse98/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-06",
  "duration_seconds": 1470,
  "transcript_sha256": "5e45a39b1abc6083d8877026c347d7ff8815052a5cc1e31606f2b38ecc4d60a8",
  "transcript_text_chars": 23617,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9931088435374149,
    "text_chars": 23617,
    "completed_at": "2026-06-29 09:52:43"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:EhsLjmqse98
```

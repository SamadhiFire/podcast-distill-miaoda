...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/I-R1bc1rlFs/transcript.txt`
- 写入结果文件：`backfill/items/youtube/I-R1bc1rlFs/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:I-R1bc1rlFs",
  "platform": "youtube",
  "platform_id": "I-R1bc1rlFs",
  ...
  "published_at": "2026-01-01T13:30:19+00:00",
  "report_date": "2026-01-02",
  "duration_seconds": 6131,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/I-R1bc1rlFs/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-01-02",
  "duration_seconds": 6131,
  "transcript_sha256": "55d625cbcdb1f89313f2ef348344ebd5bc21f002ff8aff4426a9b1b027434610",
  "transcript_text_chars": 112368,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992234545751101,
    "text_chars": 112368,
    "completed_at": "2026-06-29 12:17:27"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:I-R1bc1rlFs
```

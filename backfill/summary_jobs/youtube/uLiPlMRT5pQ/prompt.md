...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/uLiPlMRT5pQ/transcript.txt`
- 写入结果文件：`backfill/items/youtube/uLiPlMRT5pQ/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:uLiPlMRT5pQ",
  "platform": "youtube",
  "platform_id": "uLiPlMRT5pQ",
  ...
  "published_at": "2026-02-23T09:13:30+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/uLiPlMRT5pQ/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-24",
  "duration_seconds": 3274,
  "transcript_sha256": "f97b991c989d0835ae93dd2b6633c33cf19fa7404c22122cb8313e31bb1b2b2d",
  "transcript_text_chars": 59605,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9993164324984729,
    "text_chars": 59605,
    "completed_at": "2026-06-29 12:50:56"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:uLiPlMRT5pQ
```

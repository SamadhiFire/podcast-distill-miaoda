...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/VxAwUb86MUE/transcript.txt`
- 写入结果文件：`backfill/items/youtube/VxAwUb86MUE/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:VxAwUb86MUE",
  "platform": "youtube",
  "platform_id": "VxAwUb86MUE",
  ...
  "url": "https://www.youtube.com/watch?v=VxAwUb86MUE",
  "published_at": "2025-07-03T11:00:52+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/VxAwUb86MUE/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-07-04",
  "duration_seconds": 5308,
  "transcript_sha256": "2c3e1023ca2e92bc3d455c537e4d1a7dde2d9f04684b1ae0c95c8d6947eaa543",
  "transcript_text_chars": 88981,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9991107761868877,
    "text_chars": 88981,
    "completed_at": "2026-06-29 07:35:09"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:VxAwUb86MUE
```

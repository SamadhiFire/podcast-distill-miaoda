...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/o7TUaV4E5Uo/transcript.txt`
- 写入结果文件：`backfill/items/youtube/o7TUaV4E5Uo/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:o7TUaV4E5Uo",
  "platform": "youtube",
  "platform_id": "o7TUaV4E5Uo",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "Travis Kavulla Explains Why Electric Bills Shot Up | Odd Lots",
  "url": "https://www.youtube.com/watch?v=o7TUaV4E5Uo",
  "published_at": "2025-12-01T15:33:42+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/o7TUaV4E5Uo/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-02",
  "duration_seconds": 3435,
  "transcript_sha256": "82859cc682dbaf64c91181c31fd4e705912b78c890e41334d91e77e00ff309bf",
  "transcript_text_chars": 54786,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9986241630276564,
    "text_chars": 54786,
    "completed_at": "2026-06-29 11:56:49"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:o7TUaV4E5Uo
```

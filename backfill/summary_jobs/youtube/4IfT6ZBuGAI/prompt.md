...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/4IfT6ZBuGAI/transcript.txt`
- 写入结果文件：`backfill/items/youtube/4IfT6ZBuGAI/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:4IfT6ZBuGAI",
  "platform": "youtube",
  "platform_id": "4IfT6ZBuGAI",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Faded Froot Loops and Dull Doritos: Is Big Food Losing the War on Dyes?",
  "url": "https://www.youtube.com/watch?v=4IfT6ZBuGAI",
  "published_at": "2025-07-28T14:19:08+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/4IfT6ZBuGAI/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-07-29",
  "duration_seconds": 1799,
  "transcript_sha256": "b22e8ecbe9e80811aa4e83d18e678c3637b79f57d3a2753d185f73ad6f2710ff",
  "transcript_text_chars": 25825,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9985881045025015,
    "text_chars": 25825,
    "completed_at": "2026-06-29 08:19:20"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:4IfT6ZBuGAI
```

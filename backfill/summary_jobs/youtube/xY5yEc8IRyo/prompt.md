...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/xY5yEc8IRyo/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/xY5yEc8IRyo/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/xY5yEc8IRyo/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:xY5yEc8IRyo",
  "platform": "youtube",
  "platform_id": "xY5yEc8IRyo",
  "source_id": "yt_wsj_bold_names",
  "source_name": "WSJ Bold Names",
  "category": "新闻 / 时评 / 全球议题",
  "title": "From AI and Defense Tech, to Tariffs and the New Streaming Wars: The Best of Bold Names",
  "url": "https://www.youtube.com/watch?v=xY5yEc8IRyo",
  "published_at": "2025-08-29T10:31:27+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/xY5yEc8IRyo/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-30",
  "duration_seconds": 2719,
  "transcript_sha256": "ec745341ec5a202b8b4cac667246249406699dead19a8c7cbc8a65762580764e",
  "transcript_text_chars": 41341,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9970393527031997,
    "text_chars": 41341,
    "completed_at": "2026-06-29 09:41:38"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:xY5yEc8IRyo
```

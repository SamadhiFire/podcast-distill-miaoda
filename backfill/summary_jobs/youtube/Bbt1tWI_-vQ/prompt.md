...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Bbt1tWI_-vQ/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Bbt1tWI_-vQ/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Bbt1tWI_-vQ/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Bbt1tWI_-vQ",
  "platform": "youtube",
  "platform_id": "Bbt1tWI_-vQ",
  "source_id": "yt_bloomberg_originals",
  "source_name": "Bloomberg Originals",
  "category": "商业 / 财经 / 投资",
  "title": "Why Swatch May Be Running Out of Time",
  "url": "https://www.youtube.com/watch?v=Bbt1tWI_-vQ",
  "published_at": "2025-08-15T08:00:10+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Bbt1tWI_-vQ/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-16",
  "duration_seconds": 636,
  "transcript_sha256": "bc8388707a990daa3d9cd44189d608fb21cb5799dc31475716b56a866791bc08",
  "transcript_text_chars": 8998,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9919654088050315,
    "text_chars": 8998,
    "completed_at": "2026-06-29 08:57:45"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Bbt1tWI_-vQ
```

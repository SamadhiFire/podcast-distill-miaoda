...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Qt3_bK46il0/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Qt3_bK46il0/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Qt3_bK46il0/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Qt3_bK46il0",
  "platform": "youtube",
  "platform_id": "Qt3_bK46il0",
  "source_id": "yt_acq2",
  "source_name": "ACQ2",
  "category": "商业 / 财经 / 投资",
  "title": "How is AI Different Than Other Technology Waves? (With Bret Taylor and Clay Bavor) [ACQ2]",
  "url": "https://www.youtube.com/watch?v=Qt3_bK46il0",
  "published_at": "2025-08-18T17:42:39+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Qt3_bK46il0/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-19",
  "duration_seconds": 4400,
  "transcript_sha256": "4eaf0cc1a8fdc4293fb440995b7f751e08c5333702974e2b4c5bfdec97eabc4d",
  "transcript_text_chars": 78805,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9995454545454545,
    "text_chars": 78805,
    "completed_at": "2026-06-29 09:55:57"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Qt3_bK46il0
```

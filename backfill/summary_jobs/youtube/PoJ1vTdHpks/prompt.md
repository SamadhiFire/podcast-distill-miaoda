...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/PoJ1vTdHpks/transcript.txt`
- 写入结果文件：`backfill/items/youtube/PoJ1vTdHpks/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:PoJ1vTdHpks",
  "platform": "youtube",
  "platform_id": "PoJ1vTdHpks",
  ...
  "published_at": "2026-05-10T12:00:45+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/PoJ1vTdHpks/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-11",
  "duration_seconds": 5963,
  "transcript_sha256": "286118055a536868ac919006e152db9b19378778b163df113825922b29c32120",
  "transcript_text_chars": 113992,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9993761529431494,
    "text_chars": 113992,
    "completed_at": "2026-06-29 13:46:04"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:PoJ1vTdHpks
```

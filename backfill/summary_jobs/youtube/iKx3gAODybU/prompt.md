...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/iKx3gAODybU/transcript.txt`
- 写入结果文件：`backfill/items/youtube/iKx3gAODybU/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:iKx3gAODybU",
  "platform": "youtube",
  "platform_id": "iKx3gAODybU",
  ...
  "published_at": "2026-04-09T17:35:20+00:00",
  "report_date": "2026-04-10",
  "duration_seconds": 7404,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/iKx3gAODybU/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-04-10",
  "duration_seconds": 7404,
  "transcript_sha256": "7b549a1fe4d932e8ae4b941652612b6a627b41c9c6db1969206f28dc2fca5c5d",
  "transcript_text_chars": 110761,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992436520799567,
    "text_chars": 110761,
    "completed_at": "2026-06-29 13:21:45"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:iKx3gAODybU
```

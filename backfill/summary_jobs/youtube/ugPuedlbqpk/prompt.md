...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/ugPuedlbqpk/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/ugPuedlbqpk/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/ugPuedlbqpk/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:ugPuedlbqpk",
  "platform": "youtube",
  "platform_id": "ugPuedlbqpk",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "This Is What Happens When a Startup Dies | Odd Lots",
  "url": "https://www.youtube.com/watch?v=ugPuedlbqpk",
  "published_at": "2025-08-20T13:26:47+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/ugPuedlbqpk/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-21",
  "duration_seconds": 2792,
  "transcript_sha256": "7ed45335a3cda347ecbc4d86f5bfca6147a71f3e5791541a24ae68908669e4ea",
  "transcript_text_chars": 50158,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9966010028653296,
    "text_chars": 50158,
    "completed_at": "2026-06-29 09:20:12"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:ugPuedlbqpk
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/EV7WhVT270Q/transcript.txt`
- 写入结果文件：`backfill/items/youtube/EV7WhVT270Q/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:EV7WhVT270Q",
  "platform": "youtube",
  "platform_id": "EV7WhVT270Q",
  ...
  "published_at": "2026-01-31T22:33:33+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/EV7WhVT270Q/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-02",
  "duration_seconds": 15913,
  "transcript_sha256": "3f900cb868c4d931bd150bfe523399474bd28fd6dee7e6f3a91128e9e9beb382",
  "transcript_text_chars": 276251,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992609815873814,
    "text_chars": 276251,
    "completed_at": "2026-06-29 12:36:11"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:EV7WhVT270Q
```

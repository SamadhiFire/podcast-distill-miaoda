...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/yPhpc0fqu8Q/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/yPhpc0fqu8Q/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/yPhpc0fqu8Q/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:yPhpc0fqu8Q",
  "platform": "youtube",
  "platform_id": "yPhpc0fqu8Q",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/25/2025",
  "url": "https://www.youtube.com/watch?v=yPhpc0fqu8Q",
  "published_at": "2025-08-25T15:17:17+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/yPhpc0fqu8Q/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-26",
  "duration_seconds": 8652,
  "transcript_sha256": "ccb3a45a6d28c72f1676175a7208d86413d086833097756c36d4555684ea3195",
  "transcript_text_chars": 155721,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9997133610725845,
    "text_chars": 155721,
    "completed_at": "2026-06-29 09:30:29"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:yPhpc0fqu8Q
```

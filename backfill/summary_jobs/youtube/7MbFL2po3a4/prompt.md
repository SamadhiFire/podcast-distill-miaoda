...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/7MbFL2po3a4/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/7MbFL2po3a4/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/7MbFL2po3a4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:7MbFL2po3a4",
  "platform": "youtube",
  "platform_id": "7MbFL2po3a4",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "Does China's Stock Rally Have Legs? | The China Show 8/19/2025",
  "url": "https://www.youtube.com/watch?v=7MbFL2po3a4",
  "published_at": "2025-08-19T06:13:49+00:00",
  "report_date": "2025-08-20",
  "duration_seconds": 5507,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/7MbFL2po3a4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-20",
  "duration_seconds": 5507,
  "transcript_sha256": "87ed19d8650bd147e6e0a40c48d444c07cc35203a2cce5cb77df388ab1133007",
  "transcript_text_chars": 88283,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9994516070455782,
    "text_chars": 88283,
    "completed_at": "2026-06-29 09:16:12"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:7MbFL2po3a4
```

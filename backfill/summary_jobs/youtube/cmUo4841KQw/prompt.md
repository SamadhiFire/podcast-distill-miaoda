...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/cmUo4841KQw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/cmUo4841KQw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:cmUo4841KQw",
  "platform": "youtube",
  "platform_id": "cmUo4841KQw",
  ...
  "published_at": "2025-12-09T14:03:10+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/cmUo4841KQw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-10",
  "duration_seconds": 5306,
  "transcript_sha256": "610d4f4c6f7b0a6e616325b6c255e3169a0635f607786e4d976663d9ce8022aa",
  "transcript_text_chars": 91736,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9985525819826611,
    "text_chars": 91736,
    "completed_at": "2026-06-29 12:02:31"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:cmUo4841KQw
```

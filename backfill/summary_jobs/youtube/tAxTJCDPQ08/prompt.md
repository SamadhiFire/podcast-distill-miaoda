...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/tAxTJCDPQ08/transcript.txt`
- 写入结果文件：`backfill/items/youtube/tAxTJCDPQ08/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:tAxTJCDPQ08",
  "platform": "youtube",
  "platform_id": "tAxTJCDPQ08",
  ...
  "published_at": "2026-02-12T13:01:39+00:00",
  "report_date": "2026-02-13",
  "duration_seconds": 4369,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/tAxTJCDPQ08/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-13",
  "duration_seconds": 4369,
  "transcript_sha256": "0a6b089f72a028f116f47841df3a979bc3441ec3f0b686c09ec5100646811bc9",
  "transcript_text_chars": 66460,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9981231403067063,
    "text_chars": 66460,
    "completed_at": "2026-06-29 12:44:33"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:tAxTJCDPQ08
```

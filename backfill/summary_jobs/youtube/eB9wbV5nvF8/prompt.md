...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/eB9wbV5nvF8/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/eB9wbV5nvF8/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/eB9wbV5nvF8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:eB9wbV5nvF8",
  "platform": "youtube",
  "platform_id": "eB9wbV5nvF8",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/7/2025",
  "url": "https://www.youtube.com/watch?v=eB9wbV5nvF8",
  "published_at": "2025-08-07T15:19:41+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/eB9wbV5nvF8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-08",
  "duration_seconds": 8656,
  "transcript_sha256": "83079e0ea70607666337d60b8c4fa806cbafb772efb18c10c27a7cf1e3fc81d9",
  "transcript_text_chars": 149125,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9987731053604435,
    "text_chars": 149125,
    "completed_at": "2026-06-29 08:40:30"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:eB9wbV5nvF8
```

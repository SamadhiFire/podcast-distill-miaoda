...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/xmkSf5IS-zw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/xmkSf5IS-zw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:xmkSf5IS-zw",
  "platform": "youtube",
  "platform_id": "xmkSf5IS-zw",
  ...
  "published_at": "2026-04-29T17:20:27+00:00",
  "report_date": "2026-04-30",
  "duration_seconds": 8021,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/xmkSf5IS-zw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-04-30",
  "duration_seconds": 8021,
  "transcript_sha256": "cbf7a60aeeff7fcd497ed46d019f0169766d3a90b7c20f6967066d363be74f06",
  "transcript_text_chars": 121585,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9998454058097495,
    "text_chars": 121585,
    "completed_at": "2026-06-29 13:35:14"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:xmkSf5IS-zw
```

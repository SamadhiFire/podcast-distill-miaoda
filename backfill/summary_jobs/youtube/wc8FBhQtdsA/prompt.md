...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/wc8FBhQtdsA/transcript.txt`
- 写入结果文件：`backfill/items/youtube/wc8FBhQtdsA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:wc8FBhQtdsA",
  "platform": "youtube",
  "platform_id": "wc8FBhQtdsA",
  ...
  "published_at": "2026-04-02T12:31:15+00:00",
  "report_date": "2026-04-03",
  "duration_seconds": 5991,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/wc8FBhQtdsA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-04-03",
  "duration_seconds": 5991,
  "transcript_sha256": "27b50f8b81008b9024100cc840c04611c0ee2aada254318fd8a0dce3495aafba",
  "transcript_text_chars": 111530,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9993924219662828,
    "text_chars": 111530,
    "completed_at": "2026-06-29 13:17:34"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:wc8FBhQtdsA
```

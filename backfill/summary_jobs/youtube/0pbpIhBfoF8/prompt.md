...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/0pbpIhBfoF8/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/0pbpIhBfoF8/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/0pbpIhBfoF8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:0pbpIhBfoF8",
  "platform": "youtube",
  "platform_id": "0pbpIhBfoF8",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "The AI Industry Is Becoming Like Professional Sports | Odd Lots",
  "url": "https://www.youtube.com/watch?v=0pbpIhBfoF8",
  "published_at": "2025-08-04T15:20:03+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/0pbpIhBfoF8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-05",
  "duration_seconds": 3125,
  "transcript_sha256": "ecdc641dd3fbee54fd5200e5f8fd95e8d292997badfb0e972f3ec5fc5bd6efed",
  "transcript_text_chars": 53734,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9935072,
    "text_chars": 53734,
    "completed_at": "2026-06-29 08:28:45"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:0pbpIhBfoF8
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/eyDilDvQZZM/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/eyDilDvQZZM/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/eyDilDvQZZM/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:eyDilDvQZZM",
  "platform": "youtube",
  "platform_id": "eyDilDvQZZM",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/18/2025",
  "url": "https://www.youtube.com/watch?v=eyDilDvQZZM",
  "published_at": "2025-08-18T15:47:47+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/eyDilDvQZZM/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-19",
  "duration_seconds": 8661,
  "transcript_sha256": "00db22f443fbc15731534d766a76ef4e2ac7fa258f201ab102feee1a83174804",
  "transcript_text_chars": 157253,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9986595081399375,
    "text_chars": 157253,
    "completed_at": "2026-06-29 09:09:44"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:eyDilDvQZZM
```

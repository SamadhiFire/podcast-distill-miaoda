...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/gwX5xJiSgg8/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/gwX5xJiSgg8/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/gwX5xJiSgg8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:gwX5xJiSgg8",
  "platform": "youtube",
  "platform_id": "gwX5xJiSgg8",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/22/2025",
  "url": "https://www.youtube.com/watch?v=gwX5xJiSgg8",
  "published_at": "2025-08-22T17:05:01+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/gwX5xJiSgg8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-23",
  "duration_seconds": 8662,
  "transcript_sha256": "5c193f28bed1e2677aab6b17e4839de6d5547782b37a79c9777079106f228fec",
  "transcript_text_chars": 152311,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9989332717617179,
    "text_chars": 152311,
    "completed_at": "2026-06-29 09:25:27"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:gwX5xJiSgg8
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Qp0rCU49lMs/transcript.txt`
- 写入结果文件：`backfill/items/youtube/Qp0rCU49lMs/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Qp0rCU49lMs",
  "platform": "youtube",
  "platform_id": "Qp0rCU49lMs",
  ...
  "published_at": "2025-11-30T19:30:21+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Qp0rCU49lMs/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-01",
  "duration_seconds": 11889,
  "transcript_sha256": "de0b11148d3fbb57cbb4159c471cb196bc55a45b2cbd54fa70cf94087505ceca",
  "transcript_text_chars": 210385,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9989738413659685,
    "text_chars": 210385,
    "completed_at": "2026-06-29 11:56:16"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Qp0rCU49lMs
```

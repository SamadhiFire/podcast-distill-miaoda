...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Ak8KHC3XYxM/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Ak8KHC3XYxM/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Ak8KHC3XYxM/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Ak8KHC3XYxM",
  "platform": "youtube",
  "platform_id": "Ak8KHC3XYxM",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "Trump Says Secondary Tariffs on China Possible | Bloomberg: The China Show 08/07/2025",
  "url": "https://www.youtube.com/watch?v=Ak8KHC3XYxM",
  "published_at": "2025-08-07T13:32:30+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Ak8KHC3XYxM/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-08",
  "duration_seconds": 5575,
  "transcript_sha256": "b1d067ef5f641571d67d6f9ac711c9ba276a745cd9fc9f14ec0acfd9b4438029",
  "transcript_text_chars": 85104,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.998665470852018,
    "text_chars": 85104,
    "completed_at": "2026-06-29 09:54:33"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Ak8KHC3XYxM
```

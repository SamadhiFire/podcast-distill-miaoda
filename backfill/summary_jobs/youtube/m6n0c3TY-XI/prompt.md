...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/m6n0c3TY-XI/transcript.txt`
- 写入结果文件：`backfill/items/youtube/m6n0c3TY-XI/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:m6n0c3TY-XI",
  "platform": "youtube",
  "platform_id": "m6n0c3TY-XI",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "Jack Ma Returns to ‘Make Alibaba Great Again’",
  "url": "https://www.youtube.com/watch?v=m6n0c3TY-XI",
  "published_at": "2025-09-16T04:18:14+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/m6n0c3TY-XI/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-17",
  "duration_seconds": 357,
  "transcript_sha256": "21356c026bbb171b94535043d295f05685f3f7e1024170bff7052bd0573e3de7",
  "transcript_text_chars": 5941,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9969719887955182,
    "text_chars": 5941,
    "completed_at": "2026-06-29 10:18:13"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:m6n0c3TY-XI
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/O4vWEnDuZ2o/transcript.txt`
- 写入结果文件：`backfill/items/youtube/O4vWEnDuZ2o/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:O4vWEnDuZ2o",
  "platform": "youtube",
  "platform_id": "O4vWEnDuZ2o",
  ...
  "published_at": "2026-02-20T06:00:30+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/O4vWEnDuZ2o/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-21",
  "duration_seconds": 2270,
  "transcript_sha256": "fbd3ca1d16e7e757b71dc0438995578c3cdc562e978a050971e468d8d7fe669a",
  "transcript_text_chars": 34215,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9983814977973569,
    "text_chars": 34215,
    "completed_at": "2026-06-29 12:49:21"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:O4vWEnDuZ2o
```

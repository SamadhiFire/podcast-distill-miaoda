...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/X_ZVSPcZhtw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/X_ZVSPcZhtw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:X_ZVSPcZhtw",
  "platform": "youtube",
  "platform_id": "X_ZVSPcZhtw",
  ...
  "published_at": "2026-05-15T16:20:46+00:00",
  "report_date": "2026-05-16",
  "duration_seconds": 9438,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/X_ZVSPcZhtw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-16",
  "duration_seconds": 9438,
  "transcript_sha256": "b3b0d60a4e528adf7cd17fc2b0128c0a3fc88fad99044c0ebaa97eddf4486e0d",
  "transcript_text_chars": 159063,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9996948506039416,
    "text_chars": 159063,
    "completed_at": "2026-06-29 13:51:18"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:X_ZVSPcZhtw
```

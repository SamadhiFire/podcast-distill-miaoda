...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/e-ibLQTtOJY/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/e-ibLQTtOJY/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/e-ibLQTtOJY/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:e-ibLQTtOJY",
  "platform": "youtube",
  "platform_id": "e-ibLQTtOJY",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "The Investors Who Think Hazelnuts Will Be the Next Pistachios | Odd Lots",
  "url": "https://www.youtube.com/watch?v=e-ibLQTtOJY",
  "published_at": "2025-08-14T13:47:02+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/e-ibLQTtOJY/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-15",
  "duration_seconds": 2571,
  "transcript_sha256": "e697cd26727254276eea41b264adcb68108c17d8842ec011c6e6f135b7fcc324",
  "transcript_text_chars": 39975,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9969078179696617,
    "text_chars": 39975,
    "completed_at": "2026-06-29 08:55:42"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:e-ibLQTtOJY
```

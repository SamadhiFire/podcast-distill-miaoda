...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/M7E9euLwWtE/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/M7E9euLwWtE/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/M7E9euLwWtE/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:M7E9euLwWtE",
  "platform": "youtube",
  "platform_id": "M7E9euLwWtE",
  "source_id": "yt_invest_like_best",
  "source_name": "Invest Like The Best",
  "category": "商业 / 财经 / 投资",
  "title": "The Data on America's Economic Split | Andrew Milgram Interview",
  "url": "https://www.youtube.com/watch?v=M7E9euLwWtE",
  "published_at": "2025-08-05T12:30:27+00:00",
  "report_date": "2025-08-06",
  "duration_seconds": 5967,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/M7E9euLwWtE/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-06",
  "duration_seconds": 5967,
  "transcript_sha256": "a43ff5ee611e60a3f5b1a17abbfa3d40fdf630f4b1b7a8c379dcec61646872be",
  "transcript_text_chars": 92302,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9990346907993967,
    "text_chars": 92302,
    "completed_at": "2026-06-29 09:52:01"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:M7E9euLwWtE
```

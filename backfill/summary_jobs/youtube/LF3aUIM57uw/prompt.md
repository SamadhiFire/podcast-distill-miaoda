...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/LF3aUIM57uw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/LF3aUIM57uw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:LF3aUIM57uw",
  "platform": "youtube",
  "platform_id": "LF3aUIM57uw",
  ...
  "published_at": "2026-04-23T12:00:39+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/LF3aUIM57uw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-04-24",
  "duration_seconds": 2734,
  "transcript_sha256": "8b21c63dbb613a3abcf5d77574e8fe4ef32bdd5901c4e86d6125d08d6c7528e5",
  "transcript_text_chars": 52871,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9976298463789319,
    "text_chars": 52871,
    "completed_at": "2026-06-29 13:30:38"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:LF3aUIM57uw
```

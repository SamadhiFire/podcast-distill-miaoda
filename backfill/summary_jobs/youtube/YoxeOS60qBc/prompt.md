...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/YoxeOS60qBc/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/YoxeOS60qBc/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/YoxeOS60qBc/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:YoxeOS60qBc",
  "platform": "youtube",
  "platform_id": "YoxeOS60qBc",
  "source_id": "yt_sequoia",
  "source_name": "Sequoia Capital",
  "category": "科技 / AI / VC",
  "title": "Building the Generative Web with AI ft Vercel CEO Guillermo Rauch",
  "url": "https://www.youtube.com/watch?v=YoxeOS60qBc",
  "published_at": "2025-08-05T09:00:53+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/YoxeOS60qBc/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-06",
  "duration_seconds": 3660,
  "transcript_sha256": "887e70f4efc7ce524bf81122542aa59e0285bd227b1c03913f3a7b9c3802385d",
  "transcript_text_chars": 58359,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9962732240437159,
    "text_chars": 58359,
    "completed_at": "2026-06-29 09:51:21"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:YoxeOS60qBc
```

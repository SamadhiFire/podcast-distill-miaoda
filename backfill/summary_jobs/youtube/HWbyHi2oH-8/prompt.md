...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/HWbyHi2oH-8/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/HWbyHi2oH-8/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/HWbyHi2oH-8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:HWbyHi2oH-8",
  "platform": "youtube",
  "platform_id": "HWbyHi2oH-8",
  "source_id": "yt_bloomberg_china",
  "source_name": "Bloomberg The China Show",
  "category": "商业 / 财经 / 投资",
  "title": "China's Stock Rally Sparks Warnings, Debate | The China Show 8/29/2025",
  "url": "https://www.youtube.com/watch?v=HWbyHi2oH-8",
  "published_at": "2025-08-29T05:53:41+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/HWbyHi2oH-8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-30",
  "duration_seconds": 5572,
  "transcript_sha256": "eab792bff608d2a52484f72f2226845c0f4dfc7c818d4d6079ac95e595127039",
  "transcript_text_chars": 92649,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.998402727925341,
    "text_chars": 92649,
    "completed_at": "2026-06-29 09:40:48"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:HWbyHi2oH-8
```

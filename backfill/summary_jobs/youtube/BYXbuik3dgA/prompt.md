...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/BYXbuik3dgA/transcript.txt`
- 写入结果文件：`backfill/items/youtube/BYXbuik3dgA/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:BYXbuik3dgA",
  "platform": "youtube",
  "platform_id": "BYXbuik3dgA",
  ...
  "published_at": "2026-02-05T17:02:28+00:00",
  "report_date": "2026-02-06",
  "duration_seconds": 10186,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/BYXbuik3dgA/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-06",
  "duration_seconds": 10186,
  "transcript_sha256": "7c2fdf87f02635e9a97a59ca83fe19255aaa87dac89f116fb901ce35e48f3c28",
  "transcript_text_chars": 158219,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9996230119772236,
    "text_chars": 158219,
    "completed_at": "2026-06-29 12:39:48"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:BYXbuik3dgA
```

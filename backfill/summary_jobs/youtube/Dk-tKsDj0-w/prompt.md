...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Dk-tKsDj0-w/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Dk-tKsDj0-w/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Dk-tKsDj0-w/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Dk-tKsDj0-w",
  "platform": "youtube",
  "platform_id": "Dk-tKsDj0-w",
  "source_id": "yt_wsj_take_on_week",
  "source_name": "WSJ Take On the Week",
  "category": "新闻 / 时评 / 全球议题",
  "title": "Are Stablecoins the Future of Payments? | WSJ’s Take On the Week",
  "url": "https://www.youtube.com/watch?v=Dk-tKsDj0-w",
  "published_at": "2025-08-10T10:00:21+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Dk-tKsDj0-w/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-11",
  "duration_seconds": 1451,
  "transcript_sha256": "43bb2f29b682dc37dfb9c941ce9177176372b1ad18aa6a7a45daed2c03bd2a7f",
  "transcript_text_chars": 24495,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9954100620261888,
    "text_chars": 24495,
    "completed_at": "2026-06-29 08:45:25"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Dk-tKsDj0-w
```

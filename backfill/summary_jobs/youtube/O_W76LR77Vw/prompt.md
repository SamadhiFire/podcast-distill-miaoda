...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/O_W76LR77Vw/transcript.txt`
- 写入结果文件：`backfill/items/youtube/O_W76LR77Vw/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:O_W76LR77Vw",
  "platform": "youtube",
  "platform_id": "O_W76LR77Vw",
  ...
  "published_at": "2025-12-28T13:30:33+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/O_W76LR77Vw/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-12-29",
  "duration_seconds": 5777,
  "transcript_sha256": "ebaee4ce8f5d6d497178b491c3de042986325cf22c58b2c07b67645ad8a71952",
  "transcript_text_chars": 99431,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9991344988748485,
    "text_chars": 99431,
    "completed_at": "2026-06-29 12:15:49"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:O_W76LR77Vw
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/VdcD6qX8Xrc/transcript.txt`
- 写入结果文件：`backfill/items/youtube/VdcD6qX8Xrc/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:VdcD6qX8Xrc",
  "platform": "youtube",
  "platform_id": "VdcD6qX8Xrc",
  ...
  "url": "https://www.youtube.com/watch?v=VdcD6qX8Xrc",
  "published_at": "2026-05-06T08:00:36+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/VdcD6qX8Xrc/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-07",
  "duration_seconds": 1445,
  "transcript_sha256": "e162420e813ed5c25421749fa2440c2f32adc18c565b09374d9e2f44c7bc19d6",
  "transcript_text_chars": 21585,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.992083044982699,
    "text_chars": 21585,
    "completed_at": "2026-06-29 13:41:11"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:VdcD6qX8Xrc
```

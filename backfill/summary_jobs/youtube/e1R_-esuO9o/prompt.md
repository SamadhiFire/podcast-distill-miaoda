...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/e1R_-esuO9o/transcript.txt`
- 写入结果文件：`backfill/items/youtube/e1R_-esuO9o/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:e1R_-esuO9o",
  "platform": "youtube",
  "platform_id": "e1R_-esuO9o",
  ...
  "published_at": "2025-09-07T11:00:57+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/e1R_-esuO9o/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-08",
  "duration_seconds": 4703,
  "transcript_sha256": "4341a1e29e7e8bb29c89ba8784509a06aa5eceb531dca77b4629f45e42ce8a39",
  "transcript_text_chars": 73607,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9988177758877311,
    "text_chars": 73607,
    "completed_at": "2026-06-29 09:54:19"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:e1R_-esuO9o
```

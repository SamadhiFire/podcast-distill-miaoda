...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/MIiE-SGbXy8/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/MIiE-SGbXy8/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/MIiE-SGbXy8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:MIiE-SGbXy8",
  "platform": "youtube",
  "platform_id": "MIiE-SGbXy8",
  "source_id": "yt_business_breakdowns",
  "source_name": "Business Breakdowns",
  "category": "商业 / 财经 / 投资",
  "title": "PE Perspective on Insurance Brokers - [Business Breakdowns, EP.225]",
  "url": "https://www.youtube.com/watch?v=MIiE-SGbXy8",
  "published_at": "2025-08-17T21:03:07+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/MIiE-SGbXy8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-18",
  "duration_seconds": 3516,
  "transcript_sha256": "eb82fd2407fc7c3c0caf0faac5debd3fed672a342269bf5462af036fe091254c",
  "transcript_text_chars": 55009,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9987144482366326,
    "text_chars": 55009,
    "completed_at": "2026-06-29 09:06:28"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:MIiE-SGbXy8
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/I0vbIRljwLE/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/I0vbIRljwLE/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/I0vbIRljwLE/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:I0vbIRljwLE",
  "platform": "youtube",
  "platform_id": "I0vbIRljwLE",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/1/2025",
  "url": "https://www.youtube.com/watch?v=I0vbIRljwLE",
  "published_at": "2025-08-01T15:32:55+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/I0vbIRljwLE/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-02",
  "duration_seconds": 9048,
  "transcript_sha256": "1c19a4f6ffe396d11eba106b5611bed786ec9165f4f3506296ff6caa5480476f",
  "transcript_text_chars": 160401,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9990893015030946,
    "text_chars": 160401,
    "completed_at": "2026-06-29 08:26:56"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:I0vbIRljwLE
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/k-H4nsOTuxU/transcript.txt`
- 写入结果文件：`backfill/items/youtube/k-H4nsOTuxU/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:k-H4nsOTuxU",
  "platform": "youtube",
  "platform_id": "k-H4nsOTuxU",
  ...
  "published_at": "2026-04-05T12:30:57+00:00",
  "report_date": "2026-04-06",
  "duration_seconds": 6769,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/k-H4nsOTuxU/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-04-06",
  "duration_seconds": 6769,
  "transcript_sha256": "de5d749bc2348737241798df8b72e66b0b8cb737b58c3a0367c31acb045ce6d2",
  "transcript_text_chars": 120325,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9994858915644852,
    "text_chars": 120325,
    "completed_at": "2026-06-29 13:18:56"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:k-H4nsOTuxU
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Rumft-rsEu4/transcript.txt`
- 写入结果文件：`backfill/items/youtube/Rumft-rsEu4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Rumft-rsEu4",
  "platform": "youtube",
  "platform_id": "Rumft-rsEu4",
  "source_id": "yt_sequoia",
  "source_name": "Sequoia Capital",
  "category": "科技 / AI / VC",
  "title": "Knowing What Your Customers Want, All the Time: Listen Labs' Alfred Wahlforss",
...
把下面 JSON 写入 `backfill/items/youtube/Rumft-rsEu4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-06-03",
  "duration_seconds": 2423,
  "transcript_sha256": "3349237c6c0c1afeed53dcd57dd5ac4f86181123dddbaf717bd76e822d45ed02",
  "transcript_text_chars": 39036,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9997028477094512,
    "text_chars": 39036,
    "completed_at": "2026-06-29 14:02:41"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Rumft-rsEu4
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/0sNOaD9xT_4/transcript.txt`
- 写入结果文件：`backfill/items/youtube/0sNOaD9xT_4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:0sNOaD9xT_4",
  "platform": "youtube",
  "platform_id": "0sNOaD9xT_4",
  ...
  "published_at": "2025-11-20T17:00:01+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/0sNOaD9xT_4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-11-21",
  "duration_seconds": 2893,
  "transcript_sha256": "766193f3015436f59859fa304f665ed351bf7987158ac229075b0e1e27476a9d",
  "transcript_text_chars": 50135,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9987694434842724,
    "text_chars": 50135,
    "completed_at": "2026-06-29 11:50:29"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:0sNOaD9xT_4
```

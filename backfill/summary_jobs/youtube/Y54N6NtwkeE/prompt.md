...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Y54N6NtwkeE/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Y54N6NtwkeE/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Y54N6NtwkeE/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Y54N6NtwkeE",
  "platform": "youtube",
  "platform_id": "Y54N6NtwkeE",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "Circle's CEO on the Booming Business of Stablecoins | Odd Lots",
  "url": "https://www.youtube.com/watch?v=Y54N6NtwkeE",
  "published_at": "2025-07-31T14:37:44+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Y54N6NtwkeE/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-01",
  "duration_seconds": 2967,
  "transcript_sha256": "c01c631291953896b85b00908d46fbe4e3ee4067fff82d2e18d0b95532b5c666",
  "transcript_text_chars": 50498,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.996309403437816,
    "text_chars": 50498,
    "completed_at": "2026-06-29 08:24:44"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Y54N6NtwkeE
```

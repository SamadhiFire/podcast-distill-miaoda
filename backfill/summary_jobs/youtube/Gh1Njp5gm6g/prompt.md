...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/Gh1Njp5gm6g/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/Gh1Njp5gm6g/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/Gh1Njp5gm6g/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:Gh1Njp5gm6g",
  "platform": "youtube",
  "platform_id": "Gh1Njp5gm6g",
  "source_id": "yt_interesting_times",
  "source_name": "Interesting Times with Ross Douthat",
  "category": "新闻 / 时评 / 全球议题",
  "title": "The MAGA Woman Dress Code",
  "url": "https://www.youtube.com/watch?v=Gh1Njp5gm6g",
  "published_at": "2025-08-28T14:45:56+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/Gh1Njp5gm6g/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-29",
  "duration_seconds": 1209,
  "transcript_sha256": "06cdf9b8598f6c80a61934d2b884379ec66be24c95e65c9064540fb5d8d8a4ad",
  "transcript_text_chars": 18883,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9905707196029776,
    "text_chars": 18883,
    "completed_at": "2026-06-29 09:39:34"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:Gh1Njp5gm6g
```

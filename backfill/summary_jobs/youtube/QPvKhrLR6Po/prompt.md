...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/QPvKhrLR6Po/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/QPvKhrLR6Po/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/QPvKhrLR6Po/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:QPvKhrLR6Po",
  "platform": "youtube",
  "platform_id": "QPvKhrLR6Po",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 7/31/2025",
  "url": "https://www.youtube.com/watch?v=QPvKhrLR6Po",
  "published_at": "2025-07-31T15:41:09+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/QPvKhrLR6Po/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-01",
  "duration_seconds": 8652,
  "transcript_sha256": "7e93fc3625959e287e3c8866339c968e7d95bfa056e84faa6a3318632cf4422f",
  "transcript_text_chars": 155181,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9983437355524735,
    "text_chars": 155181,
    "completed_at": "2026-06-29 08:25:16"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:QPvKhrLR6Po
```

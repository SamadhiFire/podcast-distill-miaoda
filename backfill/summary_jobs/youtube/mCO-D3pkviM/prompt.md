...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/mCO-D3pkviM/transcript.txt`
- 写入结果文件：`backfill/items/youtube/mCO-D3pkviM/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:mCO-D3pkviM",
  "platform": "youtube",
  "platform_id": "mCO-D3pkviM",
  ...
  "published_at": "2026-05-02T15:01:17+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/mCO-D3pkviM/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-05-03",
  "duration_seconds": 5243,
  "transcript_sha256": "ea1f5f7f28fca4f999cc5a46ec93f9a761e25bf2ddefd886801e860c99ce4ae7",
  "transcript_text_chars": 88220,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992447072286859,
    "text_chars": 88220,
    "completed_at": "2026-06-29 13:39:10"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:mCO-D3pkviM
```

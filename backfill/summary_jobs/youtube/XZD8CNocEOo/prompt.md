...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/XZD8CNocEOo/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/XZD8CNocEOo/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/XZD8CNocEOo/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:XZD8CNocEOo",
  "platform": "youtube",
  "platform_id": "XZD8CNocEOo",
  "source_id": "yt_the_daily",
  "source_name": "The Daily",
  "category": "新闻 / 时评 / 全球议题",
  "title": "What C.E.O.s Really Think About Trump’s Tariffs",
  "url": "https://www.youtube.com/watch?v=XZD8CNocEOo",
  "published_at": "2025-08-11T14:58:23+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/XZD8CNocEOo/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-12",
  "duration_seconds": 1717,
  "transcript_sha256": "d119621518056e198c87531d171c1ef688a7b667a0b0e89133ab28c5b043faf3",
  "transcript_text_chars": 25485,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9958648806057077,
    "text_chars": 25485,
    "completed_at": "2026-06-29 08:47:15"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:XZD8CNocEOo
```

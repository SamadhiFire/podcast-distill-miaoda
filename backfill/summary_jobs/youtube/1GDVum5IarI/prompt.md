...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/1GDVum5IarI/transcript.txt`
- 写入结果文件：`backfill/items/youtube/1GDVum5IarI/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:1GDVum5IarI",
  "platform": "youtube",
  "platform_id": "1GDVum5IarI",
  ...
  "url": "https://www.youtube.com/watch?v=1GDVum5IarI",
  "published_at": "2025-11-23T12:00:03+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/1GDVum5IarI/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-11-24",
  "duration_seconds": 6320,
  "transcript_sha256": "9e2c486c5ac3441e32720f75b140f8abcd95cee2cd923915e1dd85eb3a4e4410",
  "transcript_text_chars": 103723,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9991392405063292,
    "text_chars": 103723,
    "completed_at": "2026-06-29 11:52:11"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:1GDVum5IarI
```

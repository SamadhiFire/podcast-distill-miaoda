...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/RFKFaJfvBqE/transcript.txt`
- 写入结果文件：`backfill/items/youtube/RFKFaJfvBqE/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:RFKFaJfvBqE",
  "platform": "youtube",
  "platform_id": "RFKFaJfvBqE",
  ...
  "url": "https://www.youtube.com/watch?v=RFKFaJfvBqE",
  "published_at": "2025-09-09T09:00:40+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/RFKFaJfvBqE/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-10",
  "duration_seconds": 2589,
  "transcript_sha256": "e700558f2a73655cfbf7a3423d5d74da37748962c882a4ee0fe47c829ce3ca3d",
  "transcript_text_chars": 45773,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9946504441869448,
    "text_chars": 45773,
    "completed_at": "2026-06-29 09:57:58"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:RFKFaJfvBqE
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/ja6fWTDPQl4/transcript.txt`
- 写入结果文件：`backfill/items/youtube/ja6fWTDPQl4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:ja6fWTDPQl4",
  "platform": "youtube",
  "platform_id": "ja6fWTDPQl4",
  ...
  "published_at": "2025-09-18T11:01:23+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/ja6fWTDPQl4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-09-19",
  "duration_seconds": 4028,
  "transcript_sha256": "8fb0198251ae4a6e589993d46f06e9af381698f06ce5148d4ea6f020f77439ad",
  "transcript_text_chars": 68479,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9987288977159882,
    "text_chars": 68479,
    "completed_at": "2026-06-29 10:24:18"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:ja6fWTDPQl4
```

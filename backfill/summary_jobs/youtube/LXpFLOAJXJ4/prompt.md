...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/LXpFLOAJXJ4/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/LXpFLOAJXJ4/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/LXpFLOAJXJ4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:LXpFLOAJXJ4",
  "platform": "youtube",
  "platform_id": "LXpFLOAJXJ4",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/27/2025",
  "url": "https://www.youtube.com/watch?v=LXpFLOAJXJ4",
  "published_at": "2025-08-27T15:10:35+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/LXpFLOAJXJ4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-28",
  "duration_seconds": 8653,
  "transcript_sha256": "ddb56c940117874f603ef135f6fe7ef5c34c938184f85623f32518953488c484",
  "transcript_text_chars": 160452,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9995608459493818,
    "text_chars": 160452,
    "completed_at": "2026-06-29 09:37:03"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:LXpFLOAJXJ4
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/imGWyjq5W5U/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/imGWyjq5W5U/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/imGWyjq5W5U/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:imGWyjq5W5U",
  "platform": "youtube",
  "platform_id": "imGWyjq5W5U",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/6/2025",
  "url": "https://www.youtube.com/watch?v=imGWyjq5W5U",
  "published_at": "2025-08-06T15:27:02+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/imGWyjq5W5U/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-07",
  "duration_seconds": 8658,
  "transcript_sha256": "c0cd44c011fd54788fa16df6fdd2c3facc04c72c85160708ebb99c7ac15e241b",
  "transcript_text_chars": 151770,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9992192192192192,
    "text_chars": 151770,
    "completed_at": "2026-06-29 09:53:54"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:imGWyjq5W5U
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/iIY6ylR3DtU/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/iIY6ylR3DtU/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/iIY6ylR3DtU/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:iIY6ylR3DtU",
  "platform": "youtube",
  "platform_id": "iIY6ylR3DtU",
  "source_id": "yt_bloomberg_surveillance",
  "source_name": "Bloomberg Surveillance Full Shows",
  "category": "商业 / 财经 / 投资",
  "title": "Bloomberg Surveillance 8/26/2025",
  "url": "https://www.youtube.com/watch?v=iIY6ylR3DtU",
  "published_at": "2025-08-26T15:33:51+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/iIY6ylR3DtU/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-27",
  "duration_seconds": 8651,
  "transcript_sha256": "31638ba34be27306c541e036bc5ab4e10601686f82ca72168e74fbbcebfe2530",
  "transcript_text_chars": 153603,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9996809617385273,
    "text_chars": 153603,
    "completed_at": "2026-06-29 09:35:13"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:iIY6ylR3DtU
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/WyJV6VwEGA8/transcript.txt`
- 写入结果文件：`backfill/items/youtube/WyJV6VwEGA8/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:WyJV6VwEGA8",
  "platform": "youtube",
  "platform_id": "WyJV6VwEGA8",
  ...
  "published_at": "2025-10-16T11:00:58+00:00",
  "report_date": "2025-10-17",
  "duration_seconds": 5210,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/WyJV6VwEGA8/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-10-17",
  "duration_seconds": 5210,
  "transcript_sha256": "f9249990392ae4a5c29f3034acedd64ad3e9eab4550f0d7ff3a4fd16d9db562e",
  "transcript_text_chars": 82063,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.998940499040307,
    "text_chars": 82063,
    "completed_at": "2026-06-29 11:18:36"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:WyJV6VwEGA8
```

...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/IqBXFwg3fk4/transcript.txt`
- 写入结果文件：`backfill/items/youtube/IqBXFwg3fk4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:IqBXFwg3fk4",
  "platform": "youtube",
  "platform_id": "IqBXFwg3fk4",
  ...
  "published_at": "2026-02-15T09:00:31+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/IqBXFwg3fk4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-02-16",
  "duration_seconds": 1442,
  "transcript_sha256": "acce8e0b1f7f12d863326f3484c6ea9c6db6dab80914ae731c3a123f9894f2d5",
  "transcript_text_chars": 22334,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9965048543689321,
    "text_chars": 22334,
    "completed_at": "2026-06-29 12:46:51"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:IqBXFwg3fk4
```

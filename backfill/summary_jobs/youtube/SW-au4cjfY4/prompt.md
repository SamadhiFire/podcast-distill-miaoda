...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/SW-au4cjfY4/transcript.txt`
- 如需核对逐字引用或时间上下文，可读取 VTT：`backfill/items/youtube/SW-au4cjfY4/transcript.vtt`
- 写入结果文件：`backfill/items/youtube/SW-au4cjfY4/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:SW-au4cjfY4",
  "platform": "youtube",
  "platform_id": "SW-au4cjfY4",
  "source_id": "yt_odd_lots_audio",
  "source_name": "Odd Lots Audio",
  "category": "商业 / 财经 / 投资",
  "title": "Joseph Torigian on Xi Zhongxun and Elite Chinese Communist Party Politics | Odd Lots",
  "url": "https://www.youtube.com/watch?v=SW-au4cjfY4",
  "published_at": "2025-08-07T12:46:59+00:00",
...
把下面 JSON 写入 `backfill/items/youtube/SW-au4cjfY4/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2025-08-08",
  "duration_seconds": 2640,
  "transcript_sha256": "21ba94f385aca052c86cd4686b83e863c11fe1a5827dc405db7d37dc7245acfa",
  "transcript_text_chars": 41321,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9901969696969697,
    "text_chars": 41321,
    "completed_at": "2026-06-29 09:54:15"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:SW-au4cjfY4
```

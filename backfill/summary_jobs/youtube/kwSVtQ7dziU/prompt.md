...
- 只处理这一条 YouTube 节目。
- 读取完整字幕：`backfill/items/youtube/kwSVtQ7dziU/transcript.txt`
- 写入结果文件：`backfill/items/youtube/kwSVtQ7dziU/summary.json`
- 不修改 SQLite。
- 不发布飞书。
- 不处理小宇宙。
- 不改动阶段 D 进程或状态。
...
```json
{
  "item_id": "youtube:kwSVtQ7dziU",
  "platform": "youtube",
  "platform_id": "kwSVtQ7dziU",
  ...
  "published_at": "2026-03-20T13:27:35+00:00",
  "report_date": "2026-03-21",
  "duration_seconds": 3992,
  "language": "en"
}
```
...
把下面 JSON 写入 `backfill/items/youtube/kwSVtQ7dziU/summary.json`。字段名必须保持一致。`digest` 必须完全基于字幕内容，不要编造字幕中没有的信息。
...
```json
{
  ...
  "report_date": "2026-03-21",
  "duration_seconds": 3992,
  "transcript_sha256": "ce3bba292a80a2aa53966f4fc3070d2f02eabfd18071548c7e94598c107eaa06",
  "transcript_text_chars": 80283,
  "extraction": {
    "method": "yt-dlp",
    "language": "en",
    "coverage_ratio": 0.9987274549098196,
    "text_chars": 80283,
    "completed_at": "2026-06-29 13:09:03"
  },
  "generation": {
    "script": "trae_agent",
...
```powershell
python scripts\backfill\validate_summary_outputs.py --platform youtube --item-id youtube:kwSVtQ7dziU
```
